...
var useActiveFilters_exports = {};
__export(useActiveFilters_exports, {
  default: () => useActiveFilters
});
module.exports = __toCommonJS(useActiveFilters_exports);
...
//# sourceMappingURL=useActiveFilters.cjs.map