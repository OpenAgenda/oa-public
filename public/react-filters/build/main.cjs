...
// src/messages/map.js
var import_react_intl27, map_default;
var init_map = __esm({
  "src/messages/map.js"() {
    import_react_intl27 = require("react-intl");
    map_default = (0, import_react_intl27.defineMessages)({
      searchHere: {
...
var import_react31, import_react_intl28, import_jsx_runtime20;
var init_SearchHereControl = __esm({
  "src/components/fields/MapField/SearchHereControl.js"() {
    import_react31 = require("@emotion/react");
    import_react_intl28 = require("react-intl");
    init_map();
    import_jsx_runtime20 = require("@emotion/react/jsx-runtime");
  }
});
...
function MarkerClusterIcon({ latitude, longitude, eventCount }) {
  ...
  const position = (0, import_react32.useMemo)(() => [latitude, longitude], [latitude, longitude]);
...
var import_react32, import_classnames5, import_react_leaflet, import_leaflet, import_react_intl29, import_leaflet_gesture_handling, import_react_final_form13, import_jsx_runtime21, padRatio, unpadRatio, worldViewport, Map, Map_default;
var init_Map = __esm({
  "src/components/fields/MapField/Map.js"() {
    import_react32 = __toESM(require("react"), 1);
    ...
    import_react_intl29 = require("react-intl");
    import_leaflet_gesture_handling = require("@openagenda/leaflet-gesture-handling");
    import_react_final_form13 = require("react-final-form");
    init_FiltersAndWidgetsContext();
    init_SearchHereControl();
    import_jsx_runtime21 = require("@emotion/react/jsx-runtime");
    padRatio = 0.2;
    ...
    Map = import_react32.default.forwardRef(
      ({
        input,
        tileAttribution,
        tileUrl,
        ...
        const mapRef = (0, import_react32.useRef)();
        const programmaticMoveRef = (0, import_react32.useRef)(false);
        const [viewport] = (0, import_react32.useState)(() => input.value ? valueToViewport(input.value) : initialViewport);
        const skipMoveRef = (0, import_react32.useRef)(true);
        const [data, setData] = (0, import_react32.useState)(() => []);
        const [displayedMarkers, setDisplayedMarkers] = (0, import_react32.useState)(false);
        const [bounds] = (0, import_react32.useState)(() => viewportToBounds(viewport || defaultViewport || worldViewport).pad(
          padRatio
        ));
        ...
        const onMapReady = (0, import_react32.useCallback)(
          ({ target: map }) => {
            mapRef.current = map;
        ...
        const searchHere = (0, import_react32.useCallback)(
          (e) => {
            e.preventDefault();
            const map = mapRef.current;
            if (!map) return;
        ...
        const [latestBounds, setLatestBounds] = (0, import_react32.useState)(false);
        const onChange = (0, import_react32.useCallback)(() => {
          const map = mapRef.current;
        ...
        const disabledMapSearch = (0, import_react32.useMemo)(
        ...
        const gestureHandlingOptions = (0, import_react32.useMemo)(
          () => ({
            locale: intl.locale
          }),
          [intl.locale]
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(
            import_react_leaflet.MapContainer,
            {
              ...
              worldCopyJump: true,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_react_leaflet.TileLayer, { attribution: tileAttribution, url: tileUrl }),
                displayedMarkers ? data.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
                  MarkerClusterIcon,
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(OnMapMove, { onChange })
              ]
            }
          ),
          !disabledMapSearch ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(SearchHereControlComponent, { searchHere }) : null
        ] });
      }
    );
    Map_default = Map;
...
var import_qs5 = __toESM(require("qs"), 1);
var dateFnsLocales = __toESM(require("date-fns/locale/index.js"), 1);
var import_react_portal_ssr3 = require("@openagenda/react-portal-ssr");
...
function extractFiltersFromDom() {
  ...
  return Array.from(filterElems, (elem) => {
    ...
    if (dataSet.type === "custom" || dataSet.type === "favorites") {
      ...
      dataSet.elemRef = import_react2.default.createRef();
    }
    return dataSet;
  });
}
...
function getFilterTitle(intl, providedMessages, messageKey, fieldSchema) {
  const messages13 = providedMessages ?? filterTitles_default;
  if (fieldSchema == null ? void 0 : fieldSchema.label) {
    return (0, import_intl2.getLocaleValue)(fieldSchema.label, intl.locale);
  }
  if (messages13[messageKey]) {
    return intl.formatMessage(messages13[messageKey]);
  }
  return messageKey;
}
...
var FiltersForm = import_react3.default.forwardRef(
  ({ onSubmit, initialValues, manualSubmit, subscription: subscription12, children }, ref) => {
    const { filters } = (0, import_react3.useContext)(FiltersAndWidgetsContext_default);
    const submittedValuesRef = (0, import_react3.useRef)();
    ...
    (0, import_react3.useImperativeHandle)(ref, () => form);
    const onValueChange = (0, import_react3.useCallback)(
      ({ dirty, values }) => {
        if (manualSubmit) {
          return;
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_final_form.Form, { form, subscription: subscription12, children: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      children,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_final_form.FormSpy, { subscription: spySubscription, onChange: onValueChange })
    ] }) });
  }
);
var IntlProvided = import_react3.default.forwardRef(
  ({
    filters: rawFilters,
    widgets: rawWidgets,
    missingValue,
    ...
    const filtersOptions = (0, import_react3.useMemo)(
      () => ({
        missingValue,
        mapTiles,
        dateFnsLocale,
    ...
    const [filters, setFilters] = (0, import_react3.useState)(() => (rawFilters ?? []).map((rawFilter) => withDefaultFilterConfig(rawFilter, intl, filtersOptions)));
    const [widgets, setWidgets] = (0, import_react3.useState)(() => rawWidgets);
    const updateFilters = (0, import_react3.useCallback)(
      (newFilters) => {
        setFilters(
    ...
    const filtersAndWidgets = (0, import_react3.useMemo)(
      () => ({
        filters,
        widgets,
...
function FiltersProvider({
  ...
  if (intl) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_intl11.RawIntlProvider, { value: intl, children: child });
  }
  return child;
}
var FiltersProvider_default = import_react3.default.forwardRef(FiltersProvider);
...
function IntlProvider({ locale, userLocales = null, children }) {
  const locales = (0, import_react4.useMemo)(
    () => (0, import_intl3.mergeLocales)(locales_compiled_exports, userLocales || {}),
    [userLocales]
  );
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_react_intl12.IntlProvider,
    {
      locale,
      messages: locales[locale],
      defaultLocale: (0, import_intl3.getSupportedLocale)(locale),
      children
    },
    locale
  );
...
function DateRangePicker({
  ...
  const dateRangeRef = (0, import_react6.useRef)(null);
  const [data, setData] = (0, import_react6.useState)(() => []);
  const {
    filtersOptions: { dateFnsLocale, searchMethod, res }
  } = (0, import_react6.useContext)(FiltersAndWidgetsContext_default);
  const [ranges, setRanges] = (0, import_react6.useState)(
    () => input.value ?? defaultGetInitialValue()
  );
  const [dragStatus, setDragStatus] = (0, import_react6.useState)(false);
  const [focusedRange, setFocusedRange] = (0, import_react6.useState)([0, 0]);
  ...
  const onSelectPreviewChange = (0, import_react6.useCallback)(
    (value) => {
      var _a;
  ...
  const onDefinedPreviewChange = (0, import_react6.useCallback)(
    (value) => {
      const dateRange = dateRangeRef.current;
  ...
  const onTemporaryChange = (0, import_react6.useCallback)(
    (item) => {
  ...
  const onDefinedRangeChange = (0, import_react6.useCallback)(
    (item) => {
      const value = [(item == null ? void 0 : item.selection) ? item.selection : item.range1];
      setRanges(value);
      onChange(value);
  ...
  const disabledDay = (0, import_react6.useCallback)(() => disabled, [disabled]);
  const rdrNoSelection = (0, import_react6.useMemo)(() => {
    const range = ranges == null ? void 0 : ranges[0];
    const hasRange = range && range.endDate !== null;
    return !hasRange && !dragStatus;
  }, [ranges, dragStatus]);
  const [focusedDate, setFocusedDate] = (0, import_react6.useState)(null);
  ...
  const dayContentRenderer = (0, import_react6.useCallback)(
    (day) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        staticRanges.length ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
...
var DateRangePicker_default = import_react6.default.forwardRef(DateRangePicker);
...
function useFilterTitle(messageKey, fieldSchema, messages13) {
  const intl = (0, import_react_intl14.useIntl)();
  return (0, import_react7.useMemo)(
    () => getFilterTitle(intl, messages13, messageKey, fieldSchema),
    [intl, messages13, messageKey, fieldSchema]
  );
}
...
var messages2 = (0, import_react_intl15.defineMessages)({
  removeFilter: {
...
function ValueBadge({ label, title, onRemove, disabled }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "button",
    {
      ...
      onClick: onRemove,
      children: [
        (0, import_intl5.getLocaleValue)(label, intl.locale),
        "\xA0",
...
var messages3 = (0, import_react_intl16.defineMessages)({
  dateRange: {
...
function Preview({
  ...
  const selectedStaticRange = (0, import_react11.useMemo)(
    () => value && staticRanges.find((v) => v.isSelected(value, tz)),
    [value, staticRanges, tz]
  );
  const singleDay = (0, import_react11.useMemo)(
  ...
  const onRemove = (0, import_react11.useCallback)(
    (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
...
var DateRangeFilter = import_react11.default.forwardRef(function DateRangeFilter2({
  name,
  staticRanges,
  inputRanges,
  rangeColor,
...
var Collapsable = import_react11.default.forwardRef(function Collapsable2({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react11.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    Panel,
    {
...
var exported = import_react11.default.memo(DateRangeFilter);
...
function useActiveFilters(filters) {
  const { values } = (0, import_react_final_form4.useFormState)({ subscription: { values: true } });
  const sortedFilters = (0, import_react12.useMemo)(
...
function useChoiceState({
  ...
  const [countOptions, setCountOptions] = (0, import_react13.useState)(pageSize);
  const options = (0, import_react13.useMemo)(() => getOptions(filter), [filter, getOptions]);
  const fuse = (0, import_useConstant2.default)(
  ...
  const collator = (0, import_react13.useMemo)(
  ...
  const [foundOptions, setFoundOptions] = (0, import_react13.useState)(
    filterOptions({
      options,
      fuse,
      searchValue,
  ...
  const moreOptions = (0, import_react13.useCallback)(
    () => setCountOptions((v) => v + pageSize),
    [pageSize]
  );
  const lessOptions = (0, import_react13.useCallback)(() => setCountOptions(pageSize), [pageSize]);
  ...
  const onSearchChange = (0, import_react13.useCallback)((e) => setSearchValue(e.target.value), []);
  useIsomorphicLayoutEffect2(() => {
...
function useFavoriteState(agendaUid) {
  ...
  const setAgendaValue = (0, import_react15.useCallback)(
    (fnOrValue) => {
...
var messages4 = (0, import_react_intl18.defineMessages)({
  emptyOption: {
...
function useLoadGeoData(_apiClient, res, queryOrFn, options = {}) {
  ...
  return (0, import_react18.useCallback)(
    async (bounds, zoom) => {
      ...
      const result = await (searchMethod === "get" ? fetch(
        `${res}${getQuerySeparator(res)}${import_qs3.default.stringify(params, {
          skipNulls: true
        })}`
      ) : fetch(res, {
        method: "post",
...
function Filters({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, { children: filters.map((filter) => {
    let elem;
    switch (filter.type) {
      case "dateRange":
        elem = /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          DateRangeComponent,
          {
    ...
    if (filter.destSelector) {
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_react_portal_ssr.Portal, { selector: filter.destSelector, children: elem }, seed(filter));
    }
    return elem;
  }) });
}
var Filters_default = import_react19.default.memo(Filters);
...
function SimpleDateRangeField({ input }, _ref) {
  ...
  const onInputChange = (0, import_react20.useCallback)(
    (k, v) => {
      if (k === "gte") {
        onChange({
          ...value,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { children: [
      intl.formatMessage(messages5.startDate),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { children: [
      intl.formatMessage(messages5.endDate),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "input",
        {
...
var SimpleDateRangeField_default = import_react20.default.forwardRef(SimpleDateRangeField);
...
function formatValue2(value) {
  ...
  return {
    gte: gte ? (0, import_date_fns4.format)(gte, "yyyy-MM-dd") : null,
    lte: lte ? (0, import_date_fns4.format)(lte, "yyyy-MM-dd") : null
  };
}
function parseValue2(value) {
  ...
  const gte = value.gte ? (0, import_date_fns4.startOfDay)(new Date(value.gte)).toISOString() : null;
  const lte = value.lte ? (0, import_date_fns4.endOfDay)(new Date(value.lte)).toISOString() : null;
  const result = {};
  if (gte) result.gte = gte;
  if (lte) result.lte = lte;
...
var SimpleDateRangeFilter = import_react21.default.forwardRef(function SimpleDateRangeFilter2({ name }, ref) {
...
var Collapsable3 = import_react21.default.forwardRef(function Collapsable4({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
...
var exported2 = import_react21.default.memo(SimpleDateRangeFilter);
...
var messages6 = (0, import_react_intl20.defineMessages)({
  min: {
...
function NumberRangeField({ input }, _ref) {
  const m = (0, import_react_intl20.useIntl)().formatMessage;
  const { value, onChange } = input;
  const [gteString, setGTEString] = (0, import_react22.useState)(value == null ? void 0 : value.gte);
  const [lteString, setLTEString] = (0, import_react22.useState)(value == null ? void 0 : value.lte);
  ...
  const onInputChange = (0, import_react22.useCallback)((k, v) => {
    if (k === "gte") {
      setGTEString(v);
    } else {
      setLTEString(v);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "row", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "col-xs-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("label", { className: "sr-only", htmlFor: `number-range-${input.name}-gte`, children: m(messages6.min) }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "input",
        {
          ...
          placeholder: m(messages6.min),
          onChange: (e) => onInputChange("gte", e.target.value)
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "form-group col-xs-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("label", { className: "sr-only", htmlFor: `number-range-${input.name}-lte`, children: m(messages6.max) }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "input",
        {
          value: lteString,
...
var NumberRangeField_default = import_react22.default.forwardRef(NumberRangeField);
...
function Preview2({ name, component = FilterPreviewer, disabled, ...rest }) {
  var _a, _b;
  const { input } = (0, import_react_final_form8.useField)(name, { subscription: subscription4 });
...
var NumberRangeFilter = import_react23.default.forwardRef(function NumberRangeFilter2({ name }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    import_react_final_form8.Field,
    {
      ref,
      name,
...
var Collapsable5 = import_react23.default.forwardRef(function Collapsable6({ name, filter, component, disabled, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react23.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    Panel,
    {
...
var exported3 = import_react23.default.memo(NumberRangeFilter);
...
function useOnChoiceChange(input, preventDefault) {
  const inputRef = (0, import_react24.useRef)();
  const onChange = (0, import_react24.useMemo)(
...
var ChoiceField = import_react24.default.forwardRef(function ChoiceField2({
  input,
  getTotal,
  filter,
  option,
  ...
  const total = (0, import_react24.useMemo)(
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
        "span",
        {
          ...
          children: [
            ...
            (0, import_intl7.getLocaleValue)(option.label, intl.locale) || /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_jsx_runtime14.Fragment, { children: "\xA0" }),
...
function Preview3({
  ...
  const { input } = (0, import_react_final_form9.useField)(name, { subscription: subscription5 });
  const options = (0, import_react25.useMemo)(() => getOptions(filter), [filter, getOptions]);
  const valueOptions = (0, import_react25.useMemo)(() => {
  ...
  const onRemove = (0, import_react25.useCallback)(
    (option) => (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
  ...
  return import_react25.default.createElement(component, {
    name,
    filter,
    getOptions,
    valueOptions,
...
var ChoiceFilter = import_react25.default.forwardRef(function ChoiceFilter2({
  name,
  filter,
  getTotal,
  searchPlaceholder,
  ...
  const newOptionRef = (0, import_react25.useRef)(null);
...
var Collapsable7 = import_react25.default.forwardRef(function Collapsable8({ name, filter, component, getTotal, getOptions, disabled, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react25.useState)(filter.defaultCollapsed ?? true);
...
var exported4 = import_react25.default.memo(ChoiceFilter);
...
function DefinedRangeField({
  ...
  const { onChange } = input;
  const onDefinedRangeChange = (0, import_react27.useCallback)(
    (item) => {
      const value = [(item == null ? void 0 : item.selection) ? item.selection : item.range1];
      setRanges(value);
      onChange(value);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "rdrDateRangePickerWrapper", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
...
var DefinedRangeField_default = import_react27.default.forwardRef(DefinedRangeField);

// src/components/filters/DefinedRangeFilter.js
var import_jsx_runtime17 = require("@emotion/react/jsx-runtime");
var messages7 = (0, import_react_intl24.defineMessages)({
  singleDate: {
...
function formatValue4(value) {
  ...
  if (Array.isArray(value)) {
    return value.map((v) => ({
      ...v,
      startDate: typeof v.gte === "string" ? (0, import_date_fns5.parseISO)(v.gte) : v.gte,
      endDate: typeof v.lte === "string" ? (0, import_date_fns5.parseISO)(v.lte) : v.lte
    }));
  }
  if (typeof value === "object") {
    return [
      {
        startDate: typeof value.gte === "string" ? (0, import_date_fns5.parseISO)(value.gte) : value.gte,
        endDate: typeof value.lte === "string" ? (0, import_date_fns5.parseISO)(value.lte) : value.lte,
        key: "selection"
      }
    ];
  }
...
function parseValue5(value) {
  ...
  return {
    ...
    lte: (selection.endDate ? (0, import_date_fns5.endOfDay)(selection.endDate) : selection.endDate).toISOString(),
...
function Preview4({
  ...
  const { input } = (0, import_react_final_form10.useField)(name, {
    subscription: subscription6,
    parse: parseValue5,
    format: formatValue4
  });
  const value = (_a = input.value) == null ? void 0 : _a[0];
  const selectedStaticRange = (0, import_react28.useMemo)(
    () => value && staticRanges.find((v) => v.isSelected(value)),
    [value, staticRanges]
  );
  const singleDay = (0, import_react28.useMemo)(
    () => (value == null ? void 0 : value.startDate) && (value == null ? void 0 : value.endDate) && (0, import_date_fns5.isSameDay)(value.startDate, value.endDate),
    [value]
  );
  ...
  if (selectedStaticRange) {
    ...
    label = intl.formatMessage(messages7.until, { date: value.endDate });
  } else if (value.endDate === null) {
    label = intl.formatMessage(messages7.from, { date: value.startDate });
  } else {
    label = singleDay ? intl.formatMessage(messages7.singleDate, { date: value.startDate }) : intl.formatMessage(messages7.dateRange, {
...
var DefinedRangeFilter = import_react28.default.forwardRef(function DefinedRangeFilter2({ name, staticRanges, inputRanges }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
    import_react_final_form10.Field,
    {
      ref,
      name,
      subscription: subscription6,
...
var Collapsable9 = import_react28.default.forwardRef(function Collapsable10({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react28.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
    Panel,
    {
...
var exported5 = import_react28.default.memo(DefinedRangeFilter);
...
var messages8 = (0, import_react_intl25.defineMessages)({
  ariaLabel: {
...
function Input({ input, placeholder, ariaLabel, onButtonClick, manualSubmit }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "input-group mb-3", children: [
    ...
    !manualSubmit ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "input-group-append", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      "button",
      {
        type: "submit",
        className: "btn btn-outline-secondary",
        onClick: onButtonClick,
        "aria-label": intl.formatMessage(messages8.ariaLabel),
        children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("i", { className: "fa fa-search", "aria-hidden": "true" })
      }
    ) }) : null
  ] });
}
function SearchInput({
  ...
  const [tmpValue, setTmpValue] = (0, import_react29.useState)(input.value);
  const {
    filtersOptions: { manualSubmit }
  } = (0, import_react29.useContext)(FiltersAndWidgetsContext_default);
  ...
  const inputOnChange = (0, import_react29.useCallback)(
    (e) => {
      e.persist();
  ...
  const onButtonClick = (0, import_react29.useCallback)(
    (e) => {
      e.preventDefault();
      if (manualSearch) {
  ...
  const wrappedInput = (0, import_react29.useMemo)(
    () => ({
      ...input,
      value: tmpValue,
  ...
  return import_react29.default.createElement(inputComponent, {
    input: wrappedInput,
    onButtonClick,
    manualSubmit,
    ...rest
...
var messages9 = (0, import_react_intl26.defineMessages)({
  placeholder: {
...
function Preview5({
  ...
  const { input } = (0, import_react_final_form12.useField)(name, { subscription: subscription7 });
...
var SearchFilter = import_react30.default.forwardRef(function SearchFilter2({ name, filter, component = SearchInput, placeholder = null, ...rest }, _ref) {
  const seed = (0, import_react_uid4.useUIDSeed)();
  const intl = (0, import_react_intl26.useIntl)();
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
    import_react_final_form12.Field,
    {
      name,
      ...
      type: "text",
      filter,
      placeholder: placeholder || intl.formatMessage(messages9.placeholder),
      ...rest
    },
    seed(filter)
  );
});
var exported6 = import_react30.default.memo(SearchFilter);
...
var mapContainerStyle = import_react34.css`
  position: relative;
`;
var mapStyle = import_react34.css`
  height: 100%;
  ${markerClusterStyle}
...
function MapField({
  ...
  return !collapsed ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { css: mapContainerStyle, className: (0, import_classnames6.default)(className, mapClass), children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
    LoadableMap_default,
    {
      ref,
      input,
...
var MapField_default = import_react33.default.forwardRef(MapField);

// src/components/filters/MapFilter.js
var import_jsx_runtime23 = require("@emotion/react/jsx-runtime");
var subscription8 = { value: true };
var messages10 = (0, import_react_intl30.defineMessages)({
  previewLabel: {
...
function Preview6({
  ...
  const { input } = (0, import_react_final_form14.useField)(name, { subscription: subscription8 });
  const onRemove = (0, import_react35.useCallback)(
    (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
  ...
  return import_react35.default.createElement(component, {
    name,
    filter,
    label: intl.formatMessage(messages10.previewLabel),
    onRemove,
    disabled,
    ...rest
  });
...
var Collapsable11 = import_react35.default.forwardRef(function Collapsable12({ name, filter, disabled, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react35.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
    Panel,
    {
...
var exported7 = import_react35.default.memo(import_react35.default.forwardRef(MapFilter));
...
function Preview7({
  ...
  const onRemove = (0, import_react36.useCallback)(
    (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_react_final_form15.FormSpy, { subscription: subscription9, children: ({ values }) => {
    if (!matchQuery(values, query) || !activeFilterLabel) {
      return null;
    }
    return import_react36.default.createElement(component, {
      name,
...
function CustomFilter({ filter }) {
  const form = (0, import_react_final_form15.useForm)();
  const firstRender = (0, import_react36.useRef)(true);
  const updateForm = (0, import_react36.useCallback)(
    (e) => {
      e.preventDefault();
      e.stopPropagation();
      const query = form.getState().values;
  ...
  const onChange = (0, import_react36.useMemo)(
...
var exported8 = import_react36.default.memo(CustomFilter);
...
function Preview8({
  ...
  const form = (0, import_react_final_form16.useForm)();
  const [value] = useFavoriteState(filter.agendaUid || agendaUid);
  const onRemove = (0, import_react37.useCallback)(
    (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_react_final_form16.FormSpy, { subscription: subscription10, children: ({ values }) => {
    const query = {
      uid: value,
      favorites: "1"
    };
    ...
    return import_react37.default.createElement(component, {
      name,
      label: activeFilterLabel,
      onRemove,
      disabled,
...
var FavoritesFilter = import_react37.default.forwardRef(function FavoritesFilter2({ agendaUid, filter }, _ref) {
  const form = (0, import_react_final_form16.useForm)();
  ...
  const onChange = (0, import_react37.useMemo)(
...
var exported9 = import_react37.default.memo(FavoritesFilter);
...
var import_react39 = require("swiper/react");
...
var messages11 = (0, import_react_intl31.defineMessages)({
  selectMonth: {
...
function TimelineField({
  ...
  const {
    filtersOptions: { dateFnsLocale, searchMethod, res }
  } = (0, import_react38.useContext)(FiltersAndWidgetsContext_default);
  const monthsList = (0, import_react38.useMemo)(
  ...
  const [monthPos, setMonthPos] = (0, import_react38.useState)(() => {
  ...
  const initialDay = (0, import_react38.useMemo)(() => {
    if (Array.isArray(input.value) && input.value.length) {
      return new Date(input.value[0].startDate).getDate();
    }
    return today.getDate();
  }, [input.value]);
  const [focusedDay, setFocusedDay] = (0, import_react38.useState)(initialDay);
  ...
  const dayRefs = (0, import_react38.useRef)([]);
  const monthRefs = (0, import_react38.useRef)([]);
  const daysSwiper = (0, import_react38.useRef)(null);
  const monthsSwiper = (0, import_react38.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { ref, className, children: [
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(
      "div",
      {
        ...
        style: { display: "flex" },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { className: "swiper-button-prev oa-timeline-swiper-months-prev" }),
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
            import_react39.Swiper,
            {
              slidesPerView: "auto",
              centeredSlides: true,
              ...
              children: monthsList.map(({ month, year: monthYear }, pos) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_react39.SwiperSlide, { children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
                  "span",
                  {
                    role: "option",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { className: "swiper-button-next oa-timeline-swiper-months-next" })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(
      "div",
      {
        ...
        style: { display: "flex" },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { className: "swiper-button-prev oa-timeline-swiper-days-prev" }),
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
            import_react39.Swiper,
            {
              slidesPerView: "auto",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { className: "swiper-button-next oa-timeline-swiper-days-next" })
        ]
      }
    )
  ] });
}
var TimelineField_default = import_react38.default.forwardRef(TimelineField);

// src/components/filters/TimelineFilter.js
var import_jsx_runtime27 = require("@emotion/react/jsx-runtime");
var messages12 = (0, import_react_intl32.defineMessages)({
  dateRange: {
...
function Preview9({
  ...
  const { input } = (0, import_react_final_form17.useField)(name, { subscription: subscription11 });
  ...
  const onRemove = (0, import_react40.useCallback)(
    (e) => {
      e.stopPropagation();
...
var TimelineFilter = import_react40.default.forwardRef(function TimelineFilter2({ name, className, minDate, maxDate, shownDate, getQuery }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
    import_react_final_form17.Field,
    {
      ref,
      name,
...
var exported10 = import_react40.default.memo(TimelineFilter);
...
function FavoriteToggle({ agendaUid, eventUid, widget }) {
  ...
  const firstRender = (0, import_react41.useRef)(true);
  const latestValue = useLatest4(value);
  const eventUidStr = String(eventUid);
  const updateForm = (0, import_react41.useCallback)(
    (e) => {
      var _a;
      e.preventDefault();
      e.stopPropagation();
  ...
  const onChange = (0, import_react41.useMemo)(
...
var FiltersManager = import_react42.default.forwardRef(function FiltersManager2({
  ...
  const form = (0, import_react_final_form19.useForm)();
  ...
  const {
    ...
    filtersOptions,
    searchMethod
  } = (0, import_react42.useContext)(FiltersAndWidgetsContext_default);
  const [total, setTotal] = (0, import_react42.useState)(() => initialTotal);
  const [aggregations, setAggregations] = (0, import_react42.useState)(() => initialAggregations);
  ...
  const getQuery = (0, import_react42.useCallback)(() => form.getSubmittedValues(), [form]);
  ...
  const widgetElems = widgets.map((widget) => {
    switch (widget.name) {
      case "total":
        return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react_portal_ssr2.Portal, { selector: widget.destSelector, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Total, { total, ...widget }) }) }, widgetSeed(widget));
      case "activeFilters":
        return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react_portal_ssr2.Portal, { selector: widget.destSelector, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          ActiveFilters,
          {
            agendaUid,
            filters,
...
var Wrapper = (0, import_react42.forwardRef)(function Wrapper2(props, ref) {
  const queryClient = (0, import_useConstant3.default)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_react_query.QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(FiltersManager, { ref, ...props }) });
});
...
function renderFiltersAndWidgets({
  ref = import_react43.default.createRef(),
  res = "/events",
  locale = "en",
  locales: userLocales,
  aggregations,
  ...
  (0, import_react_portal_ssr3.prepareClientPortals)();
  const initialValues = typeof query === "string" ? import_qs5.default.parse(query, { ignoreQueryPrefix: true }) : query;
  function bindRef() {
  ...
  root.render(
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(IntlProvider, { locale, userLocales, children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
      FiltersProvider_default,
      {
        filters,
        widgets,
        onSubmit: wrapCallback(onFilterChange),
        initialValues: (0, import_omit2.default)(initialValues, "sort"),
        apiClient,
        res,
...
// src/main.js
renderFiltersAndWidgets(window.oa);
