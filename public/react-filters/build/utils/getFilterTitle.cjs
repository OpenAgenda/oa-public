...
var getFilterTitle_exports = {};
__export(getFilterTitle_exports, {
  default: () => getFilterTitle
});
module.exports = __toCommonJS(getFilterTitle_exports);
...
//# sourceMappingURL=getFilterTitle.cjs.map