...
var withDefaultFilterConfig_exports = {};
__export(withDefaultFilterConfig_exports, {
  default: () => withDefaultFilterConfig
});
module.exports = __toCommonJS(withDefaultFilterConfig_exports);
...
//# sourceMappingURL=withDefaultFilterConfig.cjs.map