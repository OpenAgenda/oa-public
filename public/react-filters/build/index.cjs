...
__export(src_exports, {
  ...
  locales: () => locales_compiled_exports,
  ...
  useField: () => import_react_final_form12.useField,
  useFilterTitle: () => useFilterTitle,
  useFilters: () => useFilters,
  useForm: () => import_react_final_form12.useForm,
...
function useFilters(intl, fields, opts = {}) {
  ...
  return (0, import_react27.useMemo)(
    () => getFilters(intl, fields, opts).map((filter) => ({
      ...filter,
      id: seed(filter),
      elemRef: (0, import_react27.createRef)()
    })),
    [
      intl,
      fields,
...
var exported7 = import_react31.default.memo(FavoritesFilter);
...
function NumberRangeField({ input }, _ref) {
  ...
  const [gteString, setGTEString] = (0, import_react32.useState)(value == null ? void 0 : value.gte);
  const [lteString, setLTEString] = (0, import_react32.useState)(value == null ? void 0 : value.lte);
  ...
  const onInputChange = (0, import_react32.useCallback)((k, v) => {
    if (k === "gte") {
      setGTEString(v);
    } else {
      setLTEString(v);
...
var NumberRangeField_default = import_react32.default.forwardRef(NumberRangeField);
...
var NumberRangeFilter = import_react33.default.forwardRef(function NumberRangeFilter2({ name }, ref) {
...
var Collapsable9 = import_react33.default.forwardRef(function Collapsable10({ name, filter, component, disabled, ...rest }, ref) {
...
var exported8 = import_react33.default.memo(NumberRangeFilter);
...
function SimpleDateRangeField({ input }, _ref) {
  ...
  const { value, onChange } = input;
  const onInputChange = (0, import_react34.useCallback)(
    (k, v) => {
      if (k === "gte") {
        onChange({
          ...value,
...
var SimpleDateRangeField_default = import_react34.default.forwardRef(SimpleDateRangeField);
...
var SimpleDateRangeFilter = import_react35.default.forwardRef(function SimpleDateRangeFilter2({ name }, ref) {
...
var Collapsable11 = import_react35.default.forwardRef(function Collapsable12({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
...
var exported9 = import_react35.default.memo(SimpleDateRangeFilter);
...
function Filters({
  ...
  const seed = (0, import_react_uid5.useUIDSeed)();
...
var Filters_default = import_react36.default.memo(Filters);
...
var import_react38 = require("swiper/react");
...
function TimelineField({
  ...
  const {
    filtersOptions: { dateFnsLocale, searchMethod, res }
  } = (0, import_react37.useContext)(FiltersAndWidgetsContext_default);
  const monthsList = (0, import_react37.useMemo)(
  ...
  const [monthPos, setMonthPos] = (0, import_react37.useState)(() => {
  ...
  const initialDay = (0, import_react37.useMemo)(() => {
    if (Array.isArray(input.value) && input.value.length) {
      return new Date(input.value[0].startDate).getDate();
    }
    return today.getDate();
  }, [input.value]);
  const [focusedDay, setFocusedDay] = (0, import_react37.useState)(initialDay);
  ...
  const dayRefs = (0, import_react37.useRef)([]);
  const monthRefs = (0, import_react37.useRef)([]);
  const daysSwiper = (0, import_react37.useRef)(null);
  const monthsSwiper = (0, import_react37.useRef)(null);
          ...
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
            import_react38.Swiper,
            {
              ...
              children: monthsList.map(({ month, year: monthYear }, pos) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_react38.SwiperSlide, { children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
                  "span",
                  {
                    role: "option",
...
var TimelineField_default = import_react37.default.forwardRef(TimelineField);
...
function Preview9({
  ...
  const onRemove = (0, import_react39.useCallback)(
    (e) => {
      e.stopPropagation();
...
var TimelineFilter = import_react39.default.forwardRef(function TimelineFilter2({ name, className, minDate, maxDate, shownDate, getQuery }, ref) {
...
var exported10 = import_react39.default.memo(TimelineFilter);
...
function FavoriteToggle({ agendaUid, eventUid, widget }) {
  ...
  const firstRender = (0, import_react40.useRef)(true);
  const latestValue = useLatest4(value);
  const eventUidStr = String(eventUid);
  const updateForm = (0, import_react40.useCallback)(
    (e) => {
      var _a;
      e.preventDefault();
      e.stopPropagation();
  ...
  const onChange = (0, import_react40.useMemo)(
...
var import_react_uid6 = require("react-uid");
...
var FiltersManager = import_react41.default.forwardRef(function FiltersManager2({
  ...
  const widgetSeed = (0, import_react_uid6.useUIDSeed)();
  const {
    filters,
    widgets,
    setFilters,
    ...
    filtersOptions,
    searchMethod
  } = (0, import_react41.useContext)(FiltersAndWidgetsContext_default);
  const [total, setTotal] = (0, import_react41.useState)(() => initialTotal);
  const [aggregations, setAggregations] = (0, import_react41.useState)(() => initialAggregations);
  ...
  const getQuery = (0, import_react41.useCallback)(() => form.getSubmittedValues(), [form]);
...
var Wrapper = (0, import_react41.forwardRef)(function Wrapper2(props, ref) {
...
var FiltersForm = import_react42.default.forwardRef(
  ({ onSubmit, initialValues, manualSubmit, subscription: subscription12, children }, ref) => {
    const { filters } = (0, import_react42.useContext)(FiltersAndWidgetsContext_default);
    const submittedValuesRef = (0, import_react42.useRef)();
    ...
    (0, import_react42.useImperativeHandle)(ref, () => form);
...
var IntlProvided = import_react42.default.forwardRef(
  ({
    filters: rawFilters,
    widgets: rawWidgets,
    missingValue,
    ...
    const filtersOptions = (0, import_react42.useMemo)(
      () => ({
        missingValue,
        mapTiles,
        dateFnsLocale,
    ...
    const [filters, setFilters] = (0, import_react42.useState)(() => (rawFilters ?? []).map((rawFilter) => withDefaultFilterConfig(rawFilter, intl, filtersOptions)));
    const [widgets, setWidgets] = (0, import_react42.useState)(() => rawWidgets);
    const updateFilters = (0, import_react42.useCallback)(
      (newFilters) => {
        setFilters(
    ...
    const filtersAndWidgets = (0, import_react42.useMemo)(
      () => ({
        filters,
        widgets,
...
var FiltersProvider_default = import_react42.default.forwardRef(FiltersProvider);
...
function Sort({ options = defaultOptions }) {
  ...
  const [userSort, setUserSort] = (0, import_react43.useState)(() => form.getState().values.sort);
  const orderOptions = (0, import_react43.useMemo)(
    () => [
      {
...
function IntlProvider({ locale, userLocales = null, children }) {
  const locales = (0, import_react44.useMemo)(
