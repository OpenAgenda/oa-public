...
var IntlProvider_exports = {};
__export(IntlProvider_exports, {
  default: () => IntlProvider
});
module.exports = __toCommonJS(IntlProvider_exports);
...
function IntlProvider({ locale, userLocales = null, children }) {
  const locales = (0, import_react.useMemo)(
    () => (0, import_intl.mergeLocales)(locales_compiled_exports, userLocales || {}),
    [userLocales]
  );
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_intl.IntlProvider,
    {
      ...
      defaultLocale: (0, import_intl.getSupportedLocale)(locale),
      children
    },
    locale
  );
