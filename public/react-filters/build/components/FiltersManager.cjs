...
var import_react2, FiltersAndWidgetsContext, FiltersAndWidgetsContext_default;
var init_FiltersAndWidgetsContext = __esm({
  "src/contexts/FiltersAndWidgetsContext.js"() {
    import_react2 = require("react");
    FiltersAndWidgetsContext = (0, import_react2.createContext)({
      filters: [],
      widgets: [],
      setFilters: () => {
      },
...
// src/messages/map.js
var import_react_intl25, map_default;
var init_map = __esm({
  "src/messages/map.js"() {
    import_react_intl25 = require("react-intl");
    map_default = (0, import_react_intl25.defineMessages)({
      searchHere: {
...
var import_react29, import_react_intl26, import_jsx_runtime18;
var init_SearchHereControl = __esm({
  "src/components/fields/MapField/SearchHereControl.js"() {
    import_react29 = require("@emotion/react");
    import_react_intl26 = require("react-intl");
    init_map();
...
function MarkerClusterIcon({ latitude, longitude, eventCount }) {
  ...
  const position = (0, import_react30.useMemo)(() => [latitude, longitude], [latitude, longitude]);
...
var import_react30, import_classnames5, import_react_leaflet, import_leaflet, import_react_intl27, import_leaflet_gesture_handling, import_react_final_form12, import_jsx_runtime19, padRatio, unpadRatio, worldViewport, Map, Map_default;
var init_Map = __esm({
  "src/components/fields/MapField/Map.js"() {
    import_react30 = __toESM(require("react"), 1);
    ...
    import_react_final_form12 = require("react-final-form");
    ...
    Map = import_react30.default.forwardRef(
      ({
        input,
        tileAttribution,
        tileUrl,
        ...
        } = (0, import_react30.useContext)(FiltersAndWidgetsContext_default);
        const mapRef = (0, import_react30.useRef)();
        const programmaticMoveRef = (0, import_react30.useRef)(false);
        const [viewport] = (0, import_react30.useState)(() => input.value ? valueToViewport(input.value) : initialViewport);
        const skipMoveRef = (0, import_react30.useRef)(true);
        const [data, setData] = (0, import_react30.useState)(() => []);
        const [displayedMarkers, setDisplayedMarkers] = (0, import_react30.useState)(false);
        const [bounds] = (0, import_react30.useState)(() => viewportToBounds(viewport || defaultViewport || worldViewport).pad(
          padRatio
        ));
        ...
        const onMapReady = (0, import_react30.useCallback)(
          ({ target: map }) => {
            mapRef.current = map;
        ...
        const searchHere = (0, import_react30.useCallback)(
          (e) => {
            e.preventDefault();
            const map = mapRef.current;
            if (!map) return;
        ...
        const [latestBounds, setLatestBounds] = (0, import_react30.useState)(false);
        ...
        const disabledMapSearch = (0, import_react30.useMemo)(
        ...
        const gestureHandlingOptions = (0, import_react30.useMemo)(
          () => ({
            locale: intl.locale
          }),
          [intl.locale]
...
var FiltersManager_exports = {};
__export(FiltersManager_exports, {
  default: () => FiltersManager_default
});
module.exports = __toCommonJS(FiltersManager_exports);
...
function getDateDisplayFormat(dateFormatStyle, dateFormat, locale) {
  ...
  const fallbackChain = (0, import_intl3.getFallbackChain)(locale);
...
function DateRangePicker({
  ...
  const dateRangeRef = (0, import_react4.useRef)(null);
  ...
  const [ranges, setRanges] = (0, import_react4.useState)(
    () => input.value ?? defaultGetInitialValue()
  );
  const [dragStatus, setDragStatus] = (0, import_react4.useState)(false);
  const [focusedRange, setFocusedRange] = (0, import_react4.useState)([0, 0]);
  ...
  const onSelectPreviewChange = (0, import_react4.useCallback)(
    (value) => {
      var _a;
  ...
  const onDefinedPreviewChange = (0, import_react4.useCallback)(
    (value) => {
      const dateRange = dateRangeRef.current;
  ...
  const onTemporaryChange = (0, import_react4.useCallback)(
    (item) => {
  ...
  const onDefinedRangeChange = (0, import_react4.useCallback)(
    (item) => {
      const value = [(item == null ? void 0 : item.selection) ? item.selection : item.range1];
      setRanges(value);
      onChange(value);
  ...
  const disabledDay = (0, import_react4.useCallback)(() => disabled, [disabled]);
  const rdrNoSelection = (0, import_react4.useMemo)(() => {
    const range = ranges == null ? void 0 : ranges[0];
    const hasRange = range && range.endDate !== null;
    return !hasRange && !dragStatus;
  }, [ranges, dragStatus]);
  const [focusedDate, setFocusedDate] = (0, import_react4.useState)(null);
  ...
  const dayContentRenderer = (0, import_react4.useCallback)(
    (day) => {
...
var DateRangePicker_default = import_react4.default.forwardRef(DateRangePicker);
...
function Title({ name, filter, component, ...rest }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex-auto", children: [
    ...
    import_react6.default.createElement(component, {
      name,
      filter,
...
function Panel({
  ...
  const internalState = (0, import_react7.useState)(collapsed);
  ...
  const toggleCollapsed = (0, import_react7.useMemo)(
...
function Preview({
  ...
  const selectedStaticRange = (0, import_react9.useMemo)(
    () => value && staticRanges.find((v) => v.isSelected(value, tz)),
    [value, staticRanges, tz]
  );
  const singleDay = (0, import_react9.useMemo)(
...
var DateRangeFilter = import_react9.default.forwardRef(function DateRangeFilter2({
  name,
  staticRanges,
  inputRanges,
  rangeColor,
...
var Collapsable = import_react9.default.forwardRef(function Collapsable2({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
...
var exported = import_react9.default.memo(DateRangeFilter);
...
function useActiveFilters(filters) {
  ...
  const sortedFilters = (0, import_react10.useMemo)(
...
function useChoiceState({
  ...
  const [countOptions, setCountOptions] = (0, import_react11.useState)(pageSize);
  const options = (0, import_react11.useMemo)(() => getOptions(filter), [filter, getOptions]);
  ...
  const collator = (0, import_react11.useMemo)(
  ...
  const [foundOptions, setFoundOptions] = (0, import_react11.useState)(
    filterOptions({
      options,
      fuse,
      searchValue,
  ...
  const moreOptions = (0, import_react11.useCallback)(
    () => setCountOptions((v) => v + pageSize),
    [pageSize]
  );
  const lessOptions = (0, import_react11.useCallback)(() => setCountOptions(pageSize), [pageSize]);
  ...
  const onSearchChange = (0, import_react11.useCallback)((e) => setSearchValue(e.target.value), []);
  useIsomorphicLayoutEffect2(() => {
...
function useFavoriteState(agendaUid) {
  ...
  const setAgendaValue = (0, import_react13.useCallback)(
    (fnOrValue) => {
...
var Filters_default = import_react17.default.memo(Filters);
...
var messages5 = (0, import_react_intl17.defineMessages)({
  startDate: {
...
function SimpleDateRangeField({ input }, _ref) {
  ...
  const onInputChange = (0, import_react18.useCallback)(
    (k, v) => {
      if (k === "gte") {
        onChange({
          ...value,
...
var SimpleDateRangeField_default = import_react18.default.forwardRef(SimpleDateRangeField);
...
var SimpleDateRangeFilter = import_react19.default.forwardRef(function SimpleDateRangeFilter2({ name }, ref) {
...
var Collapsable3 = import_react19.default.forwardRef(function Collapsable4({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react19.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
    Panel,
    {
...
var exported2 = import_react19.default.memo(SimpleDateRangeFilter);
...
var messages6 = (0, import_react_intl18.defineMessages)({
  min: {
...
function NumberRangeField({ input }, _ref) {
  const m = (0, import_react_intl18.useIntl)().formatMessage;
  const { value, onChange } = input;
  const [gteString, setGTEString] = (0, import_react20.useState)(value == null ? void 0 : value.gte);
  const [lteString, setLTEString] = (0, import_react20.useState)(value == null ? void 0 : value.lte);
  ...
  const onInputChange = (0, import_react20.useCallback)((k, v) => {
    if (k === "gte") {
      setGTEString(v);
    } else {
      setLTEString(v);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "row", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "col-xs-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("label", { className: "sr-only", htmlFor: `number-range-${input.name}-gte`, children: m(messages6.min) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "form-group col-xs-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("label", { className: "sr-only", htmlFor: `number-range-${input.name}-lte`, children: m(messages6.max) }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "input",
        {
          value: lteString,
...
var NumberRangeField_default = import_react20.default.forwardRef(NumberRangeField);
...
function Preview2({ name, component = FilterPreviewer, disabled, ...rest }) {
  var _a, _b;
  const { input } = (0, import_react_final_form7.useField)(name, { subscription: subscription4 });
  const onRemove = (0, import_react21.useCallback)(
    (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
  ...
  return import_react21.default.createElement(component, {
    name,
...
var NumberRangeFilter = import_react21.default.forwardRef(function NumberRangeFilter2({ name }, ref) {
...
var Collapsable5 = import_react21.default.forwardRef(function Collapsable6({ name, filter, component, disabled, ...rest }, ref) {
...
var exported3 = import_react21.default.memo(NumberRangeFilter);
...
function useOnChoiceChange(input, preventDefault) {
  ...
  const onChange = (0, import_react22.useMemo)(
...
var ChoiceField = import_react22.default.forwardRef(function ChoiceField2({
  input,
  getTotal,
  filter,
  option,
  ...
  const total = (0, import_react22.useMemo)(
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
        "span",
        {
          ...
          children: [
            ...
            (0, import_intl6.getLocaleValue)(option.label, intl.locale) || /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: "\xA0" }),
...
var choiceFilter_default = (0, import_react_intl20.defineMessages)({
  noResult: {
...
function Preview3({
  ...
  const { input } = (0, import_react_final_form8.useField)(name, { subscription: subscription5 });
  const options = (0, import_react23.useMemo)(() => getOptions(filter), [filter, getOptions]);
  const valueOptions = (0, import_react23.useMemo)(() => {
...
var ChoiceFilter = import_react23.default.forwardRef(function ChoiceFilter2({
  name,
  filter,
  getTotal,
  searchPlaceholder,
  ...
  const newOptionRef = (0, import_react23.useRef)(null);
...
var Collapsable7 = import_react23.default.forwardRef(function Collapsable8({ name, filter, component, getTotal, getOptions, disabled, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react23.useState)(filter.defaultCollapsed ?? true);
...
var exported4 = import_react23.default.memo(ChoiceFilter);
...
var DefinedRangeField_default = import_react25.default.forwardRef(DefinedRangeField);

// src/components/filters/DefinedRangeFilter.js
var import_jsx_runtime15 = require("@emotion/react/jsx-runtime");
var messages7 = (0, import_react_intl22.defineMessages)({
  singleDate: {
...
function Preview4({
  ...
  const { input } = (0, import_react_final_form9.useField)(name, {
    subscription: subscription6,
    parse: parseValue5,
    format: formatValue4
  });
  const value = (_a = input.value) == null ? void 0 : _a[0];
  const selectedStaticRange = (0, import_react26.useMemo)(
    () => value && staticRanges.find((v) => v.isSelected(value)),
    [value, staticRanges]
  );
  const singleDay = (0, import_react26.useMemo)(
...
var DefinedRangeFilter = import_react26.default.forwardRef(function DefinedRangeFilter2({ name, staticRanges, inputRanges }, ref) {
...
var Collapsable9 = import_react26.default.forwardRef(function Collapsable10({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react26.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    Panel,
    {
...
var exported5 = import_react26.default.memo(DefinedRangeFilter);
...
var messages8 = (0, import_react_intl23.defineMessages)({
  ariaLabel: {
...
function SearchInput({
  ...
  const [tmpValue, setTmpValue] = (0, import_react27.useState)(input.value);
  const {
    filtersOptions: { manualSubmit }
  } = (0, import_react27.useContext)(FiltersAndWidgetsContext_default);
  ...
  const inputOnChange = (0, import_react27.useCallback)(
    (e) => {
      e.persist();
  ...
  const onButtonClick = (0, import_react27.useCallback)(
    (e) => {
      e.preventDefault();
      if (manualSearch) {
  ...
  const wrappedInput = (0, import_react27.useMemo)(
    () => ({
      ...input,
      value: tmpValue,
  ...
  return import_react27.default.createElement(inputComponent, {
    input: wrappedInput,
    onButtonClick,
    manualSubmit,
    ...rest
...
var messages9 = (0, import_react_intl24.defineMessages)({
  placeholder: {
...
function Preview5({
  ...
  const { input } = (0, import_react_final_form11.useField)(name, { subscription: subscription7 });
...
var SearchFilter = import_react28.default.forwardRef(function SearchFilter2({ name, filter, component = SearchInput, placeholder = null, ...rest }, _ref) {
...
var exported6 = import_react28.default.memo(SearchFilter);
...
var mapContainerStyle = import_react32.css`
  position: relative;
`;
var mapStyle = import_react32.css`
  height: 100%;
  ${markerClusterStyle}
...
var MapField_default = import_react31.default.forwardRef(MapField);
...
function Preview6({
  ...
  const { input } = (0, import_react_final_form13.useField)(name, { subscription: subscription8 });
  const onRemove = (0, import_react33.useCallback)(
    (e) => {
      e.stopPropagation();
      if (disabled) {
        return;
  ...
  return import_react33.default.createElement(component, {
    name,
    filter,
...
function MapFilter({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    import_react_final_form13.Field,
    {
      collapsed,
      ref,
      name,
...
var Collapsable11 = import_react33.default.forwardRef(function Collapsable12({ name, filter, disabled, ...rest }, ref) {
  const [collapsed, setCollapsed] = (0, import_react33.useState)(true);
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    Panel,
    {
...
var exported7 = import_react33.default.memo(import_react33.default.forwardRef(MapFilter));
...
function Preview7({
  ...
  const form = (0, import_react_final_form14.useForm)();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_react_final_form14.FormSpy, { subscription: subscription9, children: ({ values }) => {
...
function CustomFilter({ filter }) {
  const form = (0, import_react_final_form14.useForm)();
  const firstRender = (0, import_react34.useRef)(true);
  const updateForm = (0, import_react34.useCallback)(
    (e) => {
      e.preventDefault();
      e.stopPropagation();
      const query = form.getState().values;
  ...
  const onChange = (0, import_react34.useMemo)(
...
var exported8 = import_react34.default.memo(CustomFilter);
...
var FavoritesFilter = import_react35.default.forwardRef(function FavoritesFilter2({ agendaUid, filter }, _ref) {
  const form = (0, import_react_final_form15.useForm)();
  const firstRender = (0, import_react35.useRef)(true);
  const [value] = useFavoriteState(filter.agendaUid || agendaUid);
  const latestValue = useLatest3(value);
  const updateForm = useFavoritesOnChange(value, {
    isExclusive: filter.exclusive
  });
  const onChange = (0, import_react35.useMemo)(
...
var exported9 = import_react35.default.memo(FavoritesFilter);
...
//# sourceMappingURL=FiltersManager.cjs.map