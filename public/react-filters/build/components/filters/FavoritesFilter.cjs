...
var FavoritesFilter_exports = {};
__export(FavoritesFilter_exports, {
  default: () => FavoritesFilter_default
});
module.exports = __toCommonJS(FavoritesFilter_exports);
...
function useFavoriteState(agendaUid) {
  ...
  const setAgendaValue = (0, import_react4.useCallback)(
    (fnOrValue) => {
...
function Preview({
  ...
  const form = (0, import_react_final_form3.useForm)();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react_final_form3.FormSpy, { subscription, children: ({ values }) => {
    const query = {
      uid: value,
      favorites: "1"
    };
...
var FavoritesFilter = import_react5.default.forwardRef(function FavoritesFilter2({ agendaUid, filter }, _ref) {
  const form = (0, import_react_final_form3.useForm)();
  ...
  const onChange = (0, import_react5.useMemo)(
...
var exported = import_react5.default.memo(FavoritesFilter);
exported.Preview = Preview;
var FavoritesFilter_default = exported;
//# sourceMappingURL=FavoritesFilter.cjs.map