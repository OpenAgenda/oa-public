...
var SimpleDateRangeFilter_exports = {};
__export(SimpleDateRangeFilter_exports, {
  default: () => SimpleDateRangeFilter_default
});
module.exports = __toCommonJS(SimpleDateRangeFilter_exports);
...
var SimpleDateRangeField_default = import_react4.default.forwardRef(SimpleDateRangeField);
...
var FiltersAndWidgetsContext = (0, import_react5.createContext)({
  filters: [],
  widgets: [],
  setFilters: () => {
  },
...
function getDateDisplayFormat(dateFormatStyle, dateFormat, locale) {
  ...
  const fallbackChain = (0, import_intl2.getFallbackChain)(locale);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        "\xA0",
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("i", { className: "fa fa-times", "aria-hidden": "true" })
      ]
    }
  );
}
...
function FilterPreviewer({
  ...
  if (valueOptions == null ? void 0 : valueOptions.length) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: valueOptions.map((option) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ValueBadge,
      {
        label: option.label,
  ...
  if (label) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ValueBadge,
      {
        label,
        onRemove,
...
var SimpleDateRangeFilter = import_react10.default.forwardRef(function SimpleDateRangeFilter2({ name }, ref) {
...
var Collapsable3 = import_react10.default.forwardRef(function Collapsable4({ name, filter, component, disabled, staticRanges, inputRanges, ...rest }, ref) {
...
var exported2 = import_react10.default.memo(SimpleDateRangeFilter);
exported2.Preview = Preview;
exported2.Collapsable = Collapsable3;
var SimpleDateRangeFilter_default = exported2;
//# sourceMappingURL=SimpleDateRangeFilter.cjs.map