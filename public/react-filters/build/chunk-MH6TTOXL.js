...
function isSelected(range, _timeZone) {
  ...
  return range && (isSameDay(range.startDate, definedRange.startDate) || range.startDate === definedRange.startDate) && (isSameDay(range.endDate, definedRange.endDate) || range.endDate === definedRange.endDate);
}
...
//# sourceMappingURL=chunk-MH6TTOXL.js.map