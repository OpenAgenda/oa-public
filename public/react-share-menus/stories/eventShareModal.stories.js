...
export const ShareAll = () => {
  ...
  mock
    .onGet(
      `/${event.agendaSlug}/events/${event.uid}/action/dates?lang=${event.lang}&service=google`,
    )
    .reply(200, apiAgendas);
  mock
    .onGet(
      `/${event.agendaSlug}/events/${event.uid}/action/dates?lang=${event.lang}&service=yahoo`,
    )
    .reply(200, apiAgendas);
  mock
    .onGet(
      `/${event.agendaSlug}/events/${event.uid}/action/dates?lang=${event.lang}&service=live`,
    )
    .reply(200, apiAgendas);
  mock
    .onGet(
      `/${event.agendaSlug}/events/${event.uid}/action/dates?lang=${event.lang}&service=ics`,
    )
    .reply(200, apiAgendas);
  mock
