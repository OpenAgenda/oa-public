...
/***/ function(module, exports, __webpack_require__) {
	...
	var UID = 0,
	    ...
	    tunnelLib = __webpack_require__(9),
	    config = {
	  events: {
	    load: 'load'
	  },
	...
	var widget = function widget(elem, options) {
	  ...
	  var log,
	      controller,
	      hasNext = false,
	      // state indicating if there are more events to load

	  activeEventUid = false,
	      // state indicating if event is being displayed or not

	  autoscroll = true,
	      // state indicating if list should load automatically
	  ...
	  listPos = false,
	      ...
	      pending,
	      currentListParams = {},
	      // current know state of request params

	  tunnel,
	      // link to inside of iframe
	  ...
	  init = function init() {
	    ...
	    _initTunnel({
	      ...
	      _onEventOpen = function _onEventOpen(data) {
	    ...
	    _update({ uid: data.uid });
	      ...
	      _onEventClose = function _onEventClose(data) {
	    ...
	    _update({ uid: null });
	      ...
	      _onEventDatePlaceSelect = function _onEventDatePlaceSelect(data) {
	    ...
	    if (activeEventUid) {
	      ...
	      _onEventMapPlaceUnselect = function _onEventMapPlaceUnselect(data) {
	    ...
	    if (activeEventUid) {
	      ...
	      _isSame = function _isSame(o1, o2) {

	    return (0, _stringify2.default)(o1) == (0, _stringify2.default)(o2);
	  };

	  _onListChange = function _onListChange(data) {
	    ...
	    _processQueued();
	  }, _processQueued = function _processQueued() {
	  ...
	  }, _filtered = function _filtered(values) {
	    ...
	    return clean;
	  }, change = function change(reqParams) {
	    ...
	    log('change of params to "%s" - sending to frame', (0, _stringify2.default)(sentParams));
	    ...
	    tunnel.send(data);
	  }, _setUnsynced = function _setUnsynced() {
	    ...
	    syncTimeout = setTimeout(function () {
	      sync = true;syncTimeout = false;
	    }, 6000);
	  }, _monitorScroll = function _monitorScroll() {
	  ...
	  }, _update = function _update(params) {

	    log('updating request params "%s"', (0, _stringify2.default)(params));

	    controller.update('list', params);
	  }, _initTunnel = function _initTunnel(cbs) {

	    tunnel = tunnelLib.iTunnel({ target: elem, onReceive: function onReceive(data) {
	  ...
	  }, _repositionToFrameTop = function _repositionToFrameTop() {
	  ...
	  }, _repositionToListOffset = function _repositionToListOffset() {
	  ...
	  }, _readUid = function _readUid(src) {
	...
	__webpack_require__(10)(function (register) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadJs = __webpack_require__(11),
	    cn = __webpack_require__(2),
	    defaults = {
	  all: {
