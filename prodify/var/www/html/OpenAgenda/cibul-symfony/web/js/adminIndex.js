...
/***/ function(module, exports, __webpack_require__) {
	...
	var cn = __webpack_require__(1),
	    totalsSection = __webpack_require__(70),
	    eventsByWeek = __webpack_require__(73),
	    eventsDiff = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cn = __webpack_require__(1),
	    cLib = __webpack_require__(71),
	    lightbox = __webpack_require__(72),
	    lb,
	    // lightbox instance
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d3 = __webpack_require__(74),
	    cn = __webpack_require__(1),
	    fetch = __webpack_require__(75),
	    params = {
	  selectors: {
	...
	function _render(data) {
	  ...
	  var y = d3.scale.linear().domain([0, d3.max(data.map(function (d) {
	    return d.v;
	  }))]).range([0, 300]);

	  d3.select(".js_events_by_week").select('ul').selectAll('li').data(data).enter().append('li').style('width', function (d) {
	    return 1 / (data.length / 100) + "%";
	  }).append('div').style('height', function (d) {
	    return y(d.v) + "px";
	  }).append('label').text(function (d) {
	    return d.l;
	  }).insert('span').text(function (d) {
	    return d.v;
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var remote = __webpack_require__(76);
