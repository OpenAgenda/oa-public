...
export default function Description({
  ...
  const [description, setDescription] = useState(longDescWarning ? longDesc : value.description || null);
  return (
    <Checkbox
      ...
      sub={description?.length > 1000 ? 'Attention votre description actuelle fait plus de 1000 caracteres' : null}
    >
      {check ? (
        <Textarea
          max="1000"
