...
describe('form-schemas -09- unit (server): legacy tag sets', () => {

  it(
    'takes a form schema, a tag set and returns a form schema with the tag set groups added as fields',
    () => {
  ...
  it(
    'takes a form schema, a category set and returns a form schema with the category set added as fields',
    () => {
