  ...
  cases: [
    {
      ...
      description:
        'Sometimes the user needs to load data which he knows is incomplete. For example, a contributor saved a draft event and comes back to complete it. The form that is loaded should not show errors all over. In that case, the schema is loaded with a withErrors prop set to false',
    ...
    },
    {
      ...
      description:
        'Some other times the reason of the form load is to show the errors to the user. withErrors prop is set to true',
    ...
    },
    {
      ...
      description:
        'When a response gives back an error because something went awry',
      link: 'servererrors',
      group: 'errors',
    },
    {
    ...
    },
    {
      name: 'A Slate field',
      description:
        'A field that outputs a slate document. To be used by HTML or markdown fields',
      link: '/slate',
      group: 'types',
    },
    {
    ...
    },
    {
      ...
      description:
        'A field for uploading an image erroring because of the uploaded file size',
    ...
    },
    {
      ...
      description:
        'Some button layouts differ. A button component can be given to handle general form action. The component must accept an onSubmit prop, optionnally an onCancel',
      link: '/custombuttonedform',
    },
    {
      name: 'onSubmitSuccess',
      description:
        'The callback gives both the sent data and the successful response',
      link: '/onsubmitsuccess',
    },
    {
      name: 'Stateless',
      description:
        'Because sometimes you may want to handle the state in the parent component',
      link: '/stateless',
    },
    {
      name: 'conditional',
    ...
    },
    {
      name: 'hidden',
      description:
        'if "display" setting of field is specified as falsy, the field is not displayed',
      link: '/hidden',
    },
    {
      name: 'missinglanguage',
      description:
        'if requested language is not defined in label, other language is used for labels',
