...
export default defineMessages({
  ...
  'event.duplicate': {
    ...
    defaultMessage:
      '{actor} duplicated {object} from <hl>{duplicateOriginAgendaName}</hl> to {target}.',
  },
  'event.duplicate.withoutActor': {
    id: 'ActivityApps.notifications.eventDuplicate.withoutActor',
    defaultMessage:
      '{object} was duplicated from <hl>{duplicateOriginAgendaName}</hl> to {target}.',
  },
  'event.update': {
  ...
  'agenda.addEvent': {
    ...
    defaultMessage:
      '{actor} added {object} on {target} from <hl>{sourceAgendaName}</hl>.',
  },
  'agenda.addEvent.withoutActor': {
    id: 'ActivityApps.notifications.agendaAddEvent.withoutActor',
    defaultMessage:
      '{object} was added on {target} from <hl>{sourceAgendaName}</hl>.',
  },
});
