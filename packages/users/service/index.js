...
class Users extends Service {
  constructor( options ) {
    ...
    this.setImageProfile = httpMethod( 'POST', ':__feathersId/setImageProfile' )( this.setImageProfile );
    this.clearImageProfile = httpMethod( 'POST', ':__feathersId/clearImageProfile' )( this.clearImageProfile );
    this.requestChangeEmail = httpMethod( 'PATCH', ':__feathersId/requestChangeEmail' )( this.requestChangeEmail );
    this.confirmChangeEmail = httpMethod( 'GET', ':__feathersId/confirmChangeEmail' )( this.confirmChangeEmail );
    this.changePassword = httpMethod( 'PATCH', ':__feathersId/changePassword' )( this.changePassword );
    this.generateApiKey = httpMethod( 'GET', ':__feathersId/generateApiKey' )( this.generateApiKey );
    this.setNewFlag = httpMethod( 'PATCH', ':__feathersId/setNewFlag' )( this.setNewFlag );
  ...
  setup( app, path ) {
    ...
    app.use( `${path}/tokens`, new Tokens( {
