INSERT INTO `${activity}` (`id`, `actor`, `verb`, `object`, `target`, `store`, `created_at`) VALUES
  ...
  (8,  'user:1234',     'event.create',            'event:5678',     'agenda:9012',     '{"labels":{"actor":"Kevin","object":"Va au Starbucks","target":"le-mercure"}}', '2022-06-08 10:38:00'),
  (9,  'user:1234',     'event.update',            'event:5678',     'agenda:9012',     '{"labels":{"actor":"Kevin","object":"Boit son jus de chaussettes","target":"le-mercure"}}', '2022-06-08 10:45:00'),
  (10, 'user:1234',     'event.create',            'event:4546',     'agenda:3453',     '{"labels":{"actor":"Kevin","object":"Prend le train","target":"le-train"}}', '2022-06-08 09:20:00'),
  (11, 'user:789789',   'account.update',          'email',          'user:1234',       '{"labels":{"actor":"Rohim","object":"Email","target":"Kevin"}}', '2022-06-08 11:30:00'),
  (12, 'user:789789',   'agenda.sendInvitation',   'email:aogendo@oagenda.com', 'agenda:3453', '{"labels":{"actor":null,"object":"aogendo@oagenda.com","target":"Un agenda contributif"},"credential":1}', '2022-06-08 10:22:00');
