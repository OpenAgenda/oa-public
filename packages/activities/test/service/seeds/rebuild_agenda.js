  ...
  await knex(schemas.rebuild_agenda).insert([
    {
      ...
      main: '0',
      store:
        '{"mails":true,"order":"relative","dataviz":"[{\\"sections\\":[\\"month\\"]},{\\"sections\\":[\\"place\\"]}]","moderated":true,"send_invitation_email":true,"contributorconfigstep":-1,"cFields":{"organization":[],"contact_number":[],"contact_name":[],"contact_position":[],"email":[]}}',
      contribution_type: '1',
      contribution_info: '',
      official: '1',
      credentials:
        '{"moderators":true,"embedsHead":false,"embedsTemplates":false,"activatingInvitations":false}',
      settings:
