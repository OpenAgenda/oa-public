...
module.exports = [ {
  ...
  config: {
    interfaces: {
      ...
      getSchemaConfiguration: async () => ih( storyDefaults.schemaConfiguration, {
        extensions: { $set: [] }
      } )
    }
  },
  ...
  config: {
    interfaces: {
      getAgenda: async ( { slug } ) => storyDefaults.agenda,
      getSchemaConfiguration: async () => storyDefaults.schemaConfiguration,
      setSchema
    }
  },
  req: { lang: 'fr' }
...
async function setSchema( agenda, updatedFields ) {
