...
describe( 'get', () => {
  ...
  test( 'simple get', () => {
    ...
    expect( get( object, 'un.test[name="unNom"]' ).map( o => _.omit( o, 'tags' ) ) ).toEqual( [ {
      name: 'unNom',
      prop: 12
    }, {
      name: 'unNom',
    ...
    expect( get( object, 'un.test[name="other"].tags[].label' ) ).toEqual( [ 'Deux', 'Trois' ] );

    expect( get( object, 'un.test[name="unNom"].tags[].label' ) ).toEqual( [ 'Un', 'Deux', 'Un', 'Trois' ] );
