...
module.exports = { // this can be loaded by loadSettings mw on server side
  eventForm: {
    detailed: true
  },
  translation: {
  ...
  labels: {
    ...
    addressPlaceholder: {
      ...
      fr: 'Ex : 03 rue de Valois 75001 Paris'
    },
    "imageCredits": {
      "en": "Image credits",
  ...
  tagSet: {
    groups: [ {
      ...
      tags: [ {
        ...
        id : 36,
        label: 'Villes et pays art/histoire'
      }, {
        id : 37,
      ...
      tags: [ {
        ...
        id : 1,
        label: 'Personne Célebre'
      }, {
        id : 2,
        label: 'Château, hôtel urbain, palais, manoir'
      }, {
        id : 4,
        label: 'Édifice hospitalier'
      }, {
        id : 5,
        label: 'Édifice maritime'
      }, {
        id : 6,
        label: 'Édifice militaire'
      }, {
        id : 7,
        label: 'Archive'
      }, {
        id : 8,
        label: 'Édifice industriel'
      }, {
        id : 9,
        label: 'Édifice rural'
      }, {
        id : 10,
        label: 'Édifice scolaire'
      }, {
        id : 11,
        label: 'Édifice naturel'
      }, {
        id : 12,
        label: 'Mémoire'
      }, {
        id : 13,
        label: 'Un truc pas vide'
      }, {
        id : 14,
        label: 'Pouvoir'
      }, {
        ...
        id : 23,
        label: 'Jardin d\'inspiration médiévale'
      }, { 
        id : 24,
        label: 'Jardin régulier (à la française)'
      }, { 
        id : 25,
        label: 'Parc paysager (à l\'anglaise)'
      }, { 
        id : 26,
        label: 'Jardin XXe siècle'
      }, { 
        id : 27,
        label: 'Jardin de création récente'
      }, { 
        id : 28,
        label: 'Jardin de collection (botanique, arboretum...)'
      }, { 
        id : 29,
        label: 'Jardin vivrier (potager, verger, jardins familiaux, jardin de simples...)'
      }, { 
        id : 30,
        label: 'Jardin privé'
      }, { 
