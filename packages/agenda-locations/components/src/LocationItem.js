...
class LocationItem extends Component {
  ...
  render() {
    ...
    return <div className={className.join(' ')} key={l.uid} onClick={this.props.onSelect.bind(this)}>
      ...
      <div className="item-body">
        ...
        <div className="indicators">
          ...
          { l.agendaEventCount ?
            <a onClick={this.seeEvents.bind(this)}>{this.props.getLabel(l.agendaEventCount === 1 ? 'seeEvent' : 'seeEvents', { count: l.agendaEventCount })}</a>
