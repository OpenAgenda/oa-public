...
var _jsxFileName = "/home/bertho/oa/packages/react-form-components/components/GroupTagSelector.jsx";
...
module.exports = createReactClass({
  ...
  renderItem: function renderItem(item, groupIndex, itemIndex) {
    ...
    return React.createElement("div", {
      ...
      type: "checkbox",
      checked: checked,
      onChange: (checked ? this.removeItem : this.addItem).bind(null, item, groupIndex),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 103
      },
      __self: this
    }), item.label), this.props.tagBottom ? this.props.tagBottom(item, groupIndex, itemIndex) : null);
  },
  renderGroupHead: function renderGroupHead(group, i) {
    ...
    return React.createElement("div", {
      ...
      __self: this
    }, group.name, group.required ? ' (*)' : ''), group.info ? React.createElement("p", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 134
      },
  ...
  renderGroup: function renderGroup(group, i) {
    ...
    return React.createElement("div", {
      ...
      __self: this
    }, this.renderGroupHead(group, i), React.createElement("div", {
...
//# sourceMappingURL=GroupTagSelector.js.map