...
var _md = require("@openagenda/md");
var _turndown = _interopRequireDefault(require("turndown"));
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _jsxFileName = "/home/clement/Project/oa/packages/react-form-components/components/MarkdownComponent.jsx";
const TurndownService = _turndown.default.default || _turndown.default;
const ts = new TurndownService();
class MarkdownComponent extends _react.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("div", {
      ...
      children: [label && /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("label", {
        ...
        value: (0, _md.fromMarkdownToHTML)(value),
        style: {
          minHeight: '200px',
          visibility: 'hidden'
        },
  ...
  updateTinyMceEditor() {
    ...
    if (this.state.editorMarkdown !== this.props.value) {
      ...
      tinymce.get(this.state.editorId).setContent((0, _md.fromMarkdownToHTML)(this.props.value));
    }
  }
...
(0, _defineProperty2.default)(MarkdownComponent, "propTypes", {
...
(0, _defineProperty2.default)(MarkdownComponent, "defaultProps", {
