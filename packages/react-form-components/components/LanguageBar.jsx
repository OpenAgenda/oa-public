        ...
        {this.props.editable ? (
          <span className="language-add cform">
            {this.state.displaySelect ? (
              ...
              <a className="url" onClick={this.showSelect}>
...
var LanguageItem = createReactClass({
  ...
  renderCross() {
    return (
      <span onClick={this.onRemove} className="remove">
        &#10005;
      </span>
    );
  },
  ...
  render: function () {
    ...
    if (this.props.edited) {
      ...
      return (
        <li className={this.props.enabled ? '' : 'disabled'}>
          <div className="language-item">
            <span onClick={this.props.onEdit}>{lInfo.nativeName}</span>
            {this.props.languages.length > 1 && this.props.editable
              ? this.renderCross()
              : null}
          </div>
        </li>
