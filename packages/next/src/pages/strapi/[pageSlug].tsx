...
export const getServerSideProps: GetServerSideProps<PageProps> = async ({
  ...
  const pageRes = `${APIBase}/pages/${matches[0].documentId}?${[
    ...
    'Components',
    'Components.CTA',
    'Components.CTA.colorScheme.name',
    'Components.Modular.fontColor.name',
    'Components.Modular.backgroundColor.name',
    'Components.Modular.tagColor.name',
    'Components.Modular.maxWidth.name',
    'Components.Modular.width.name',
    'Components.Modular.fontSize.name',
    'Components.maxWidth.name',
