...
import AgendaShowMapFilter from '@/src/app/[locale]/(app)/[agendaSlug]/_components/MapFilter';
import wrapFilter from '@/src/app/[locale]/(app)/[agendaSlug]/_utils/wrapFilter';
  ...
  const loadGeoData = useLoadGeoData(
    ...
    omitParams({
      ...isUpcomingOnlyQuery(query)
        ...
        : null,
      ...applyPrefilterToEventsQuery({ prefilter, query, filters }),
