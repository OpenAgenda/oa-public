...
import CopyIdentifier from '@/src/components/CopyIdentifier';
...
import canModifyLocation from '../_utils/canModifyLocation';
import useEvent from '../_hooks/useEvent';
import useMember from '../_hooks/useMember';
import useShareModal from '../_hooks/useShareModal';
import messages from '../messages';
import fetchLocale from '../locales';
import useNcEffect from '../_hooks/useNcEffect';
...
import BottomNavigateButtons from './BottomNavigateButtons';
...
function EventShow() {
  ...
  const cl = nextSearchParams.get('cl') ?? undefined;
  const contentLocale = useMemo(
    () => getContentLocale(languages, cl, intl.locale),
    [languages, intl.locale, cl],
  );
