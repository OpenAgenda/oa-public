...
export default function FiltersPart({ agenda, filters, query }) {
  const intl = useIntl();
    ...
    <>
      ...
      >
        <Filters
          ...
          mapComponent={!isSmall || open ? (MapFilter as any) : undefined}
      ...
      <Box display={{ base: 'none', lg: 'block' }} wordBreak="normal">
        <Link href="/packages/next/public" color="primary.500">
          OpenAgenda
        </Link>
        <NoBreak>&nbsp;·</NoBreak>{' '}
        <Link
