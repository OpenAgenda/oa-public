...
export default async function fetchLocale(locale) {
  return Promise.all([
    ...
    import(
      `../[locale]/(app)/auth/magic-link/confirm/_components/locales/compiled/${locale}.json`
    ).then((mod) => mod.default),
    import(
      `../[locale]/(app)/auth/manual/_components/locales/compiled/${locale}.json`
    ).then((mod) => mod.default),
    import(
      `../[locale]/(app)/auth/reset/_components/locales/compiled/${locale}.json`
    ).then((mod) => mod.default),
    import(
    ...
    import(
      `../../components/ErrorDisplay/locales/compiled/${locale}.json`
    ).then((mod) => mod.default),
    ...
    import(
      `../../components/NavbarSearchInput/locales/compiled/${locale}.json`
    ).then((mod) => mod.default),
    import(
