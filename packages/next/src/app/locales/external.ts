...
// The event page's history section pulls ActivityApps.* labels via
// @openagenda/activity-apps, so they must be merged into the global
// IntlProvider — otherwise react-intl falls back to rendering the bare label
// id (e.g. "ActivityApps.eventCreate.full").
