...
module.exports = {
  ...
  deleteModalText: {
    en: 'Are you sure you want to delete your account? All associated data will be permanently removed from the database',
    fr: 'Etes vous certain de vouloir supprimer votre compte? Toutes les données associées seront retirées de la base de manière permanente'
  },
  deleteModalButton: {
    en: 'Delete',
    fr: 'Supprimer'
