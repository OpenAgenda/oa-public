  ...
  return Object.assign(
    (origin) => {
      ...
      Object.keys(value).forEach((l) => {
        ...
        if (
          params.optional &&
          (langValue === undefined || langValue === null)
        ) {
          return;
        }
        ...
        try {
          ...
          clean[params.forceCodesToLowerCase ? l.toLowerCase() : l] =
            validateText(langValue);
        } catch (lErrors) {
          lErrors.forEach((e) => {
