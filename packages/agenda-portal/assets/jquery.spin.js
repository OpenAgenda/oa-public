...
(function(i) {
    "function" == typeof define && define.amd ? define(["jquery", "spin"], i) : i(jQuery, Spinner)
}
)(function(i, o) {
        ...
        return this.each(function() {
            ...
            t !== !1) {
                ...
                a.css({
                    ...
                    position: "absolute",
                    "z-index": 9999,
                    top: "absolute" === n.css("position") ? 0 : n.position().top - 1,
                    left: "absolute" === n.css("position") ? 0 : n.position().left,
                    "background-color": "" + t.bgColor,
                    width: n.outerWidth(),
                    height: 0 === n.outerHeight() ? "100%" : n.outerHeight() + 1,
