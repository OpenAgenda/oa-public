  ...
  config = {
    all: {
      ...
      versions: {
        members: [ {
          version: 2,
          agendaUids: [ 48959239, 93961830, 5897476, 96165479, 11072140, 41715612, 28447894, 27744304, 56907207, 26127587, 73087674, 63338236, 47483234, 19187305, 33332852, 66274790, 72177774, 67130267, 68263389, 2445326, 19678829, 49562322, 61327284 ]
        }, {
          version: 1
        } ]
      },
