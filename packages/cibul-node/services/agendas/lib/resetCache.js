...
export default async function resetCache(services, agenda, options = {}) {
  ...
  try {
    ...
    if (before && before.slug !== agenda.slug) {
      await simpleCache.hash('agendas', before.slug).reset(expire);
    }
  } catch (e) {
