  ...
  const layoutModules = await Promise.all(
    filenames
      ...
      .map(async layoutName => {
        const layoutModule = await import(new URL(`./${layoutName}/index.mjs`, import.meta.url).pathname);
...
export const load = (layoutName, preLoaded = {}) => (content, data = {}) => {
  return mappedLayouts[layoutName](content, { ...preLoaded, ...data });
};
