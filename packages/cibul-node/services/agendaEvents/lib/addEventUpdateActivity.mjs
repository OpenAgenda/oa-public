...
import getMemberName from './utils/getMemberName.mjs';

const log = logs('agendaEvents/addEventUpdateActivity');

export default async (services, { agenda, event, user }, before, after, changeStateType) => {
  log('processing');
