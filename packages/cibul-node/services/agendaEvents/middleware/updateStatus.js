...
import toggleCancellationInTitle from '@openagenda/utils/cancellation/toggleTitle.js';
import logs from '@openagenda/logs';

const log = logs('services/agendaEvents/middleware/updateStatus');
...
export default (req, res, next) => {
  ...
  core
    ...
    .events.patch(req.event.uid, payload, {
