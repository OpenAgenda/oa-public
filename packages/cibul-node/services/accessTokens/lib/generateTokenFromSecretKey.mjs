...
import getTokenDeath from './getTokenDeath.mjs';
import { secret as getUserFromSecretKey } from './getUserFromKey.mjs';

const TOKEN_LIFESPAN = 60 * 60 * 1000;
const log = logs('services/accessTokens/generateTokenFromSecretKey');

export default async function generateTokenFromSecretKey(services, { secretKey }, options = {}) {
