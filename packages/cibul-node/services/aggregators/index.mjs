...
import Aggregators from '@openagenda/aggregators';
import logs from '@openagenda/logs';
import plugApp from './plugApp.mjs';
import onAddSource from './onAddSource.mjs';
import onRemoveSource from './onRemoveSource.mjs';

const log = logs('services/aggregators');
