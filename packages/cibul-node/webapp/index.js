  ...
  return {
    ...
    agendaSettingsEdit: {
      ...
      res: {
        ...
        keys: {
          list: '/:slug/admin/settings/api-keys',
          create: '/:slug/admin/settings/api-keys',
          update: '/:slug/admin/settings/api-keys/:id',
          remove: '/:slug/admin/settings/api-keys/:id',
        },
      },
    },
    inboxUser: {
    ...
    members: {
      ...
      res: {
        ...
        sendMessage: '/api/agendas/:agendaUid/members/sendGroupMail',
