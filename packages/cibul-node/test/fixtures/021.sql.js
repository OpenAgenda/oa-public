...
raw.push(knex('reviewer').insert([
  load('./sql/members/71386687.json', {
    ...
    user_uid: 111,
    credential: 2,
    store: JSON.stringify({ custom_fields: { email: 'helene@testmemberoa.com' } }),
  }),
  load('./sql/members/71386687.json', {
    id: 2,
    agenda_uid: 1904,
    user_uid: 222,
    credential: 3,
    store: JSON.stringify({ custom_fields: { email: 'thibaud@testmemberoa.com' } }),
  }),
  load('./sql/members/71386687.json', {
    id: 3,
    agenda_uid: 1904,
    ...
    credential: 1,
    actions_counter: 3,
    store: JSON.stringify({ custom_fields: { email: 'steve@testmemberoa.com' } }),
  }),
  load('./sql/members/71386687.json', {
    id: 4,
    agenda_uid: 1904,
