...
rawSQL.push(
  knex('reviewer').insert([
    ...
    },
    {
      ...
      store:
        '{"custom_fields":{"contact_name":"Communication Ville-bassens","email":"communication@ville-bassens.fr","contact_number":"05 57 80 81 46","organization":"Ville de Bassens"}}',
    },
  ]),
);
...
rawSQL.push(
  knex('review_tag_article').insert([
    {
      id: 1,
