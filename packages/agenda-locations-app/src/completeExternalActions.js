const completeExternalActions = (externalActions, extIds) => {
  if (!extIds || !externalActions) return { externalActions: false, usedExtIds: [] };
  ...
  if (completedExternalActions.length && usedExtIds.length) return { externalActions: completedExternalActions, usedExtIds };
