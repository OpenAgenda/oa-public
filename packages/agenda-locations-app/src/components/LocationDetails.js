    ...
    return (
      <div>
        <div>
          <span>
            <FormattedMessage
              values={{ count: nbAgendasRendered }}
              {...messages.refAgendas}
            />
          </span>
          ...
          <a
            href={`${res.agendaSearch}/${filteredLAgendas[nbAgendasRendered - 1].uid}`}
          >
            {filteredLAgendas[nbAgendasRendered - 1].title}
          </a>
          {nbAgendasUnrendered !== 0 ? (
            <span>
              <FormattedMessage {...messages.andOn} />
            </span>
          ) : null}
          {nbAgendasUnrendered !== 0 ? (
            <a href={link}>
              <FormattedMessage
                values={{ count: nbAgendasUnrendered }}
                {...messages.others}
              />{' '}
            </a>
          ) : null}
