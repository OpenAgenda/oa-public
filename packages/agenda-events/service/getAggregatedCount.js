...
import CachedCount from './lib/CachedCount.js';

const log = logs('getAggregatedCount');
...
export default (service) => {
  ...
  const cached = redisClient
    ? CachedCount(redisClient, 'getAggregatedCount', fn)
    : null;

  return Object.assign(
    (agendaUid, since = null) => (cached || fn)(agendaUid, since),
    {
