...
module.exports = {
  "title": {
    ...
    "br": "Gwiriañ ho koulenn krouiñ kont"
  },
  "context": {
    ...
    "br": "Abalamour d'ur c'hresk bras ha nevez a grouidigezhioù danvez bruderezh emgefreek war ar savenn, ur bazenn gwiriañ da c'hortoz evit ar c'hontoù nevez a zo ret."
  },
  "instruction": {
    "fr": "**Vous serez notifié rapidement de l'activation de votre compte par email (quelques minutes pendant les heures de bureau).**",
    "en": "**You will be quickly notified of the activation of your account by email (a few minutes during office hours Paris time).**",
    ...
    "br": "**Kemenn a vo graet deoc'h buan dre bostel pa vo gweredekaet ho kont (un nebeud munutennoù e-pad eurioù labour).**"
  },
  "complaint": {
    ...
    "en": "In case there is delay in processing your request, send us a message via the chat tool on our [homepage](/) or send us an email at [verif@openagenda.com](mailto:verif@openagenda.com) with the email used during the account creation.",
    ...
    "br": "Ma vez dale o tretañ ho koulenn, kasit deomp ur gemennadenn dre ar benveg flapañ hegerz war [hor pajenn degemer](/). Pe skrivit deomp da [verif@openagenda.com](mailto:verif@openagenda.com) en ur reiñ ar chomlec'h postel hoc'h eus implijet evit krouiñ ho kont."
  }
}
