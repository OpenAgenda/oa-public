...
module.exports = {
  ...
  "event": {
    ...
    "it": "{others, plural, =0 {{event}} one {{event} et 1 autre evento} other {{event} et {others} autres eventi}}",
  ...
  "email": {
    ...
    "it": "{others, plural, =0 {{email}} one {{email} et 1 autre} other {{email} et {others} autres}}",
  ...
  "agenda": {
    ...
    "it": "{others, plural, =0 {{agenda}} one {{agenda} et 1 autre} other {{agenda} et {others} autres}}",
  ...
  "agenda.sendInvitation": {
    ...
    "it": "{actorCount, plural, one {{actor} ha invité} other {{actor} hanno invitato}} {object} come {credential} su {target}.",
  ...
  "agenda.addMember": {
    ...
    "it": "{actorCount, plural, one {{actor} ha ajouté} other {{actor} hanno aggiunto}} {object} come {credential} su {target}.",
  ...
  "agenda.removeMember": {
    ...
    "it": "{actorCount, plural, one {{actor} ha rimosso} other {{actor} hanno rimosso }} {object} ({credential}) de {target}.",
  ...
  "agenda.removeMember.withYou": {
    ...
    "it": "{actor} ti  ha rimosso ({credential}) de {target}.",
  ...
  "agenda.setMemberRole": {
    ...
    "it": "{actorCount, plural, one {{actor} ha nommé} other {{actor} hanno nommé}} {object} {credential} su {target}.",
  ...
  "agenda.addSource": {
    ...
    "it": "{actorCount, plural, one {{actor} ha ajouté} other {{actor} hanno aggiunto}} {object} alle fonti di {target}.",
  ...
  "agenda.removeSource": {
    ...
    "it": "{actorCount, plural, one {{actor} ha rimosso} other {{actor} hanno rimosso }} {object} dalle fonti di {target}.",
  ...
  "agenda.updateContribution": {
    ...
    "it": "{actorCount, plural, one {{actor} ha aggiornato} other {{actor} hanno aggiornato}} ha jour le impostazioni dei contributi de {target}.",
  ...
  "agenda.updateProfile": {
    ...
    "it": "{actorCount, plural, one {{actor} ha aggiornato} other {{actor} hanno aggiornato}}  il profilo de {target}.",
  ...
  "agenda.changeEventState": {
    ...
    "it": "{actorCount, plural, one {{actor} ha messo} other {{actor} hanno messo}} {object} en \"{newState}\" su {target}.",
  ...
  "agenda.publishEvent": {
    ...
    "it": "{actorCount, plural, one {{actor} ha pubblicato} other {{actor} hanno pubblicato}} {object} su {target}.",
  ...
  "agenda.removeEvent": {
    ...
    "it": "{actorCount, plural, one {{actor} ha rimosso} other {{actor} hanno rimosso }} {object} de {target}.",
  ...
  "event.create": {
    ...
    "it": "{actorCount, plural, one {{actor} ha creato} other {{actor} hanno creato}} {object} su {target}.",
  ...
  "event.update": {
    ...
    "it": "{actorCount, plural, one {{actor} ha aggiornato} other {{actor} hanno aggiornato}}  {object} su {target}.",
  ...
  "event.delete": {
    ...
    "it": "{actorCount, plural, one {{actor} ha cancellato} other {{actor} hanno supprimé}} {object} de {target}.",
