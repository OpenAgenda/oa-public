...
module.exports = {
  ...
  "agenda.acceptInvitation": {
    ...
    "es": "%user% ha aceptado una invitación para unirse%originMember% %credencial%."
  },
  "agenda.addMember": {
    ...
    "es": "%originMember% añadió %user% como %credencial%."
  },
  "agenda.setMemberRole": {
    ...
    "es": "%user% pasó %originMember% de a %beforeCredential% %credencial%."
  },
  "agenda.create": {
