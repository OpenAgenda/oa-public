...
module.exports = {
  ...
  "lastMessagePostedRelativeDate": {
    ...
    "en": "Last message posted %date% ago",
  ...
  "creationFail": {
    ...
    "en": "There was an error creating the conversation, please try again later.",
    "de": "Es gab einen Fehler, das Gespräch zu schaffen, versuchen Sie es später noch einmal.",
    "es": "Se produjo un error durante la creación de la conversación, por favor intente de nuevo más tarde.",
  ...
  "titleContributionRequest": {
    ...
    "en": "Contribution request",
    "de": "Beitrag Anfrage",
    "es": "proceso de solicitud",
  ...
  "titleSuggestLocationChange": {
    ...
    "en": "Suggest a change on the location",
  ...
  "supportInboxDesc": {
    "fr": "<p>Vous avez une question technique sur l'usage d'OpenAgenda ? La réponse est certainement dans la documentation.</p><p><a target=\"_blank\" href=\"https://doc.openagenda.com\">Voir la documentation</a></p><p>Si votre question concerne plutôt les administrateurs d'un agenda, vous pouvez les joindre via la messagerie en bas de chacune de vos fiches événements ou bien directement sur l'agenda en cliquant sur \"contacter\".</p><p><a href=\"/home\">Voir mes agendas</a> ou <a href=\"/home/events\">voir mes événements</a></p><p>Pour tout autre question, vous pouvez nous joindre directement :</p>",
    "en": "<p>Do you have a technical question about using OpenAgenda? The answer is certainly in the documentation.</p><p><a target=\"_blank\" href=\"https://doc.openagenda.com\">See the documentation</a></p><p>If your question relates more to the administrators of a calendar, you can reach them via the messaging at the bottom of each of your event files or directly on the calendar by clicking on \"contact\".</p><p><a href=\"/home\">See my calendars</a> or <a href=\"/home/events\">see my events</a></p><p>For any other question, you can join us directly:</p>",
    "de": "<p>Haben Sie eine technische Frage zur Verwendung von OpenAgenda? Die Antwort finden Sie sicherlich in der Dokumentation.</p><p><a target=\"_blank\" href=\"https://doc.openagenda.com\">Siehe Dokumentation</a></p><p>Wenn Ihre Frage Administratoren eines Kalenders betrifft, können Sie diese über den Nachrichtendienst am Ende jeder Ihrer Ereignisdateien oder direkt im Kalender erreichen, indem Sie auf \"Kontakt\" klicken.</p><p><a href=\"/home\">Meine Kalender anzeigen</a> oder <a href=\"/home/events\">meine Veranstaltungen anzeigen</a></p><p>Bei allen anderen Fragen wenden Sie sich an Sie kann sich uns direkt anschließen:</p>",
    "es": "<p>¿Tiene alguna pregunta técnica sobre el uso de OpenAgenda? La respuesta está ciertamente en la documentación.</p><p><a target=\"_blank\" href=\"https://doc.openagenda.com\">Consulte la documentación</a></p><p>Si su pregunta se relaciona más con los administradores de un calendario, puede comunicarse con ellos a través del mensaje en la parte inferior de cada uno de sus archivos de eventos o directamente en el calendario haciendo clic en \"contacto\".</p><p><a href=\"/home\">Vea mis calendarios</a> o <a href=\"/home/events\">vea mis eventos</a></p><p>Para cualquier otra pregunta, usted puede unirse a nosotros directamente:</p>",
    "it": "<p>Hai una domanda tecnica sull'uso di OpenAgenda? La risposta è sicuramente nella documentazione.</p><p><a target=\"_blank\" href=\"https://doc.openagenda.com\">Vedi la documentazione</a></p><p>Se la tua domanda riguarda maggiormente gli amministratori di un calendario, puoi raggiungerli tramite la messaggistica in fondo a ciascuno dei tuoi file di eventi o direttamente sul calendario facendo clic su \"contatta\".</p><p><a href=\"/home\">Vedi i miei calendari</a> o <a href=\"/home/events\">vedi i miei eventi</a></p><p>Per qualsiasi altra domanda, tu puoi unirti direttamente a noi:</p>",
  ...
  "contactContributor": {
    ...
    "es": "Póngase en contacto con el contribuyente",
  ...
  "contactContributorOf": {
    ...
    "en": "Contact the contributor of <a href=\"%link%\">%title%</a>",
    "de": "Kontaktieren Sie den Beitrag von <a href=\"%link%\"> %title% </a>",
    "es": "Póngase en contacto con el contribuyente <a título href=\"%link%\">%title%</a>",
  ...
  "contactAdministratorsOf": {
    ...
    "en": "Contact the administrators of <a href=\"%link%\">%title%</a>",
    "de": "Kontaktieren Sie die Administratoren von <a href=\"%link%\"> %title% </a>",
    "es": "Contacto administradores <a href=\"%link%\"> %title% </a>",
  ...
  "contactConversationInitiated": {
    ...
    "en": "Conversation initiated on the contact form",
  ...
  "sendMessageToAdmin": {
    ...
    "en": "Send a message to agenda administrators.",
    "de": "Schicke eine Nachricht an Agenda-Administratoren.",
    "es": "Enviar un mensaje a los directores de la agenda.",
  ...
  "sendMessageToContributor": {
    ...
    "en": "Send a message to event contributor.",
    "de": "Schicke eine Nachricht an Veranstaltungen Beiträger.",
    "es": "Enviar un mensaje al colaborador del evento.",
  ...
  "yourMessageWillBeSigned": {
    ...
    "en": "Your message will be signed",
    "de": "Ihre Nachricht wird unterzeichnet",
    "es": "Se firmará su mensaje",
  ...
  "requestForContribution": {
    ...
    "en": "Request for contribution to",
    "de": "Antrag auf Beitrag",
    "es": "Las solicitudes de contribución",
  ...
  "sendMessageError": {
    ...
    "en": "We have encountered an error, please try again later.",
    "de": "Wir haben einen Fehler festgestellt, bitte versuchen Sie es später noch einmal.",
    "es": "Hemos encontrado un error, por favor inténtelo de nuevo más tarde.",
  ...
  "contactedTheContributor": {
    ...
    "en": "contacted the contributor",
    "de": "den Beitrag in Kontakt gebracht",
    "es": "en contacto con el contribuyente",
  ...
  "requestedEditingRights": {
    ...
    "en": "requested editing rights",
    "de": "angeforderte Bearbeitungsrechte",
    "es": "pidió a los derechos de publicación",
  ...
  "suggestedALocationChange": {
    ...
    "en": "suggested a change on the location",
    "de": "eine Änderung an der Stelle vorgeschlagen",
    "es": "sugiere un cambio en el lugar",
  ...
  "contactedSupport": {
    ...
    "en": "contacted the support OpenAgenda",
    "de": "kontaktiert die Stütz OpenAgenda",
    "es": "en contacto con el portador OpenAgenda",
  ...
  "requestContributeAccepted": {
    ...
    "en": "The request has been accepted.",
