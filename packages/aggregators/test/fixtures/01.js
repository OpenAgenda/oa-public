...
_append(sqlStrings, 'aggregator_source', [
  {
    // NH < NIN 1
    id: 10000,
    aggregator_id: 1000,
...
module.exports.sql = `${sqlStrings.join(';\n')};`;
...
module.exports.getObjectItems = async (object, lastId = 0, limit = 5) => {
  ...
  const remaining = module.exports.references[object.id].filter(
    ref => lastId < parseFloat(ref.refId)
  );
