...
describe('event-form utils unit tests', () => {
  ...
  describe('schemaLanguages', () => {
    ...
    it('if no value languages are defined and default values are set, they are used independently of interface language', () => {
      ...
      const languagedSchema = schemaLanguages.set(
        schemaWithDefaultLanguages,
        'is',
        [],
      );
      ...
      removeMultilingualValues(
        {
          ...
          timings: [
            {
              begin: { date: '2018-11-27', hours: 10, minutes: 10 },
              end: { date: '2018-11-27', hours: 16, minutes: 16 },
            },
          ],
          languages: ['de', 'fr'],
          title: { de: 'deuuu', fr: 'frrrrr' },
        },
        ['title', 'description', 'keywords', 'longDescription', 'conditions'],
        ['de'],
      ),
    ).toEqual({
      accessibility: { hi: true, sl: true },
