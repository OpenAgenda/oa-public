...
### [1.5.1](https://bitbucket.org/openagenda/oa/branches/compare/@openagenda/event-form@1.5.1..@openagenda/event-form@1.5.0) (2020-11-23)
...
### [1.4.9](https://bitbucket.org/openagenda/oa/branches/compare/@openagenda/event-form@1.4.9..@openagenda/event-form@1.4.8) (2020-07-13)
...
### [1.4.8](https://bitbucket.org/openagenda/oa/branches/compare/@openagenda/event-form@1.4.8..@openagenda/event-form@1.4.7) (2020-07-10)
...
* event-form: tweaks enabledRanges in Timings ([3f8121e](https://bitbucket.org/openagenda/oa/commits/3f8121e))
...
* fix(event-form): extractLanguages processes keywords incorrectly ([9a67f41](https://bitbucket.org/openagenda/oa/commits/9a67f41))
* fix(event-form): polish breaks everything ([cf729e0](https://bitbucket.org/openagenda/oa/commits/cf729e0))
* tweak(event-form): access option controls event form field loads ([8e1c950](https://bitbucket.org/openagenda/oa/commits/8e1c950))
* tweak(event-form): add option to exclude non-valued fields (languages field) ([2addd02](https://bitbucket.org/openagenda/oa/commits/2addd02))
* tweak(event-form): added creatorUid and ownerUid to internal fields ([745c693](https://bitbucket.org/openagenda/oa/commits/745c693))
* tweak(event-form): slug is an internal field ([2933026](https://bitbucket.org/openagenda/oa/commits/2933026))
...
* feature(event-form): include event private fields when explicited in options ([d9b7972](https://bitbucket.org/openagenda/oa/commits/d9b7972))
