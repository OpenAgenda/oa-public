...
const messages = defineMessages({
  ...
  moderated: {
    ...
    defaultMessage:
      '{count, plural, one {1 to be moderated} other {# to be moderated}}',
  },
  readyToPublish: {
    id: 'ReactShared.AgendaAdminModContextBar.readyToPublish',
    defaultMessage:
      '{count, plural, one {1 ready to publish} other {# ready to publish}}',
  },
  published: {
...
export default function AgendaAdminModContextBar({ res, states }) {
  const intl = useIntl();
