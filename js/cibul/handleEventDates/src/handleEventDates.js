/*verboseDate*/ if (!String.prototype.verboseDate) String.prototype.verboseDate=function(a,b,c){if(typeof a=='undefined')a='en';if(typeof b=='undefined')b=false;if(typeof c=='undefined')c=true;var e={'en':{days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],daysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],daysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],weekMin:'wk'},'fr':{days:["Dimanche","Lundi","Mardi","Mercredi","Jeudi","Vendredi","Samedi"],daysShort:["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],daysMin:["Di","Lu","Ma","Me","Je","Ve","Sa"],months:["Janvier","Fevrier","Mars","Avril","Mai","Juin","Juillet","Aout","Septembre","Octobre","Novembre","Decembre"],monthsShort:["Jan","Fev","Mar","Avr","May","Jun","Jul","Aou","Sep","Oct","Nov","Dec"],weekMin:'sm'}};var f=this.toString();var d=new Date(f.replace(/-/g,'/'));if(b){var g=e[a].days;var h=e[a].months}else{var g=e[a].daysShort;var h=e[a].monthsShort}return g[d.getDay()]+' '+d.getDate()+' '+h[d.getMonth()]+(c?', '+f.substr(0,4):'')};
