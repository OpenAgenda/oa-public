...
},{"../../widgets/calendar/calendar":13,"../../widgets/categories/categories":16,"../../widgets/controller/main":23,"../../widgets/map/map":29,"../../widgets/search/search":34,"../../widgets/tags/tags":40}],2:[function(require,module,exports){
...
},{"../common/common.mod":3,"./maps.mod":5,"leaflet":12}],7:[function(require,module,exports){
...
},{"../../js/lib/clientEjs/ejs":2,"../../js/lib/common/common.mod.js":3,"../../js/vendors/CibulCalendar/src/CibulCalendar":8,"../lib/controllerLoader":24,"../lib/widgetLib":25,"../lib/widgetStyler":26,"./main.ejs":14,"./style.css":15,"debug":9}],14:[function(require,module,exports){
...
},{"../../js/lib/common/common.mod.js":3,"../lib/controllerLoader":24,"../lib/widgetLib":25,"./dom.js":17,"debug":9}],17:[function(require,module,exports){
...
},{"../../js/lib/clientEjs/ejs":2,"../../js/lib/common/common.mod.js":3,"../lib/widgetStyler":26,"./item.ejs":18,"./main.ejs":19,"./style.css":20,"debug":9}],18:[function(require,module,exports){
...
defaults = {
  ...
  tpl: {
    agenda : '/server/testdata/controldata.json',
    embed : '//d.cibul.net/frontend_dev.php/embed/{uid}/controldata',
    search : '//d.cibul.net/widgets/{uid}/search'
  }
},
...
module.exports = function( uid ) {
  ...
  _fetchControllerData = function( cb ) {
    ...
    remote.get( res, { }, function( success, data ) {
...
},{"../../js/lib/common/common.mod.js":3,"../../js/lib/remote/remote.mod.js":7,"./filters":22,"debug":9}],22:[function(require,module,exports){
...
},{"../../js/lib/common/common.mod.js":3,"./controller":21,"debug":9}],24:[function(require,module,exports){
...
},{"../../js/lib/common/common.mod.js":3,"../../js/lib/loadJs/loadJs.mod.js":4}],25:[function(require,module,exports){
...
},{"../../js/lib/common/common.mod.js":3,"debug":9}],26:[function(require,module,exports){
var cn = require( '../../js/lib/common/common.mod.js' ),
...
},{"../../js/lib/common/common.mod.js":3}],27:[function(require,module,exports){
module.exports = {
...
module.exports = "<div class=\"map-canvas\"></div><div class=\"map-sync\"><label><%= labels.mapSync %></label><input class=\"js_sync_checkbox\" type=\"checkbox\"/></div>";
...
},{"../../js/lib/clientEjs/ejs":2,"../../js/lib/common/common.mod.js":3,"../../js/lib/maps/osm.maps.mod":6,"../lib/controllerLoader":24,"../lib/widgetLib":25,"../lib/widgetStyler":26,"./config.js":27,"./main.ejs":28,"./popup.ejs":30,"./style.css":31,"debug":9}],30:[function(require,module,exports){
module.exports = "<div class=\"map-location\"><% if (typeof count !== 'undefined') { %><span class=\"count\"><span><%= count %></span><label> <%= count==1?labels.events.replace('s', ''):labels.events %></label></span><% } %><% if (typeof image !== 'undefined') { %><img src=\"<%= image %>\"/><% } %><span><p><%= placename %></p><span><%= address %></span></span></div>";
...
},{"../../js/lib/clientEjs/ejs":2,"../../js/lib/common/common.mod.js":3,"../lib/controllerLoader":24,"../lib/widgetLib":25,"../lib/widgetStyler":26,"./config.js":32,"./main.ejs":33,"./style.css":35,"debug":9}],35:[function(require,module,exports){
...
},{"../../js/lib/clientEjs/ejs":2,"../../js/lib/common/common.mod.js":3,"../lib/widgetStyler":26,"./item.ejs":37,"./main.ejs":38,"./style.css":39,"debug":9}],37:[function(require,module,exports){
module.exports = "<li class=\"<% if ( selected ) { %>selected<% } %><% if ( active ) { %> active<% } %>\"><a><%= label %></a></li>";
...
},{"../../js/lib/common/common.mod.js":3,"../lib/controllerLoader":24,"../lib/widgetLib":25,"./dom.js":36,"debug":9}]},{},[1]);
