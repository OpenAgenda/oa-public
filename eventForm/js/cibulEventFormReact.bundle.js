...
var AccessibilityFields = React.createClass({displayName: "AccessibilityFields",
...
AccessibilityItem = React.createClass({displayName: "AccessibilityItem",
...
},{"./reactUtils.js":7,"react":170}],2:[function(require,module,exports){
"use strict";
...
module.exports = function( options ) {
  ...
  React.render(
    React.createElement(AgeFields, {initMin: values.min, initMax: values.max, lang: params.lang, onChange: rUtils.ehUpdate( params.events.send)}),
    rUtils.createCanvas( rUtils.el( params.canvas ) )
  );
...
var AgeFields = React.createClass({displayName: "AgeFields",
...
},{"./reactUtils.js":7,"react":170,"react-select":12}],3:[function(require,module,exports){
"use strict";
  ...
  render: function() {
    ...
    return ( 
      React.createElement("li", null, 
        ...
        React.createElement("label", null, this.props.field.label[this.props.labelsLang], this.props.field.optional ? '' : ' (*)')
      )
    );
...
},{"./accessibilityFields.react.js":1,"./ageFields.react.js":2,"./customFields.react.js":5,"./typeField.react.js":9}],5:[function(require,module,exports){
"use strict";
...
module.exports = function( options ) {
  ...
  React.render( React.createElement(CustomFields, {
    fields: fields, 
...
var CustomFields = React.createClass({displayName: "CustomFields",
...
},{"./checkboxField.react.js":3,"./radioFields.react.js":6,"./reactUtils":7,"./textField.react.js":8,"react":170}],6:[function(require,module,exports){
"use strict";
  ...
  render: function() {
    ...
    renderOption = function( option ) {
      ...
      return React.createElement("li", null, 
        React.createElement("input", {type: "radio", name: self.props.field.name, checked: option.value==self.props.value, onChange: self.onChange.bind( self, option.value)}), 
        React.createElement("label", null, option.label[self.props.labelsLang])
      );
    ...
    return ( 
      React.createElement("li", null, 
        React.createElement("label", null, this.props.field.label[this.props.labelsLang], this.props.field.optional ? '' : ' (*)'), 
        React.createElement("ul", null, this.props.field.options.map( renderOption)), 
...
},{"./validators":10,"react":170}],7:[function(require,module,exports){
"use strict";
...
},{"../../js/lib/common/common.mod":11}],8:[function(require,module,exports){
"use strict";
...
module.exports = React.createClass({displayName: "exports",
  ...
  renderField: function() {
    ...
    if ( [ 'integer', 'text', 'number', 'email', 'url' ].indexOf( this.props.type ) !== -1 ) {
      ...
      return React.createElement("input", {type: "text", value: this.extractFieldValue(), onChange: this.onChange});

    } else {

      return React.createElement("textarea", {value: this.extractFieldValue(), onChange: this.onChange})
  ...
  render: function() {
    ...
    return ( 
      React.createElement("li", null, 
        ...
        this.renderField(), 
         this.props.error && this.state.userHasTyped ? React.createElement("span", {className: "error"}, this.props.error) : '', 
         this.props.field.info && !( this.props.error && this.state.userHasTyped ) ? React.createElement("span", {className: "info"}, this.props.field.info[this.props.labelsLang]) : ''
      )
    );
...
},{"./validators":10,"react":170,"utils":171}],9:[function(require,module,exports){
"use strict";
...
module.exports = function( options ) {
  ...
  React.render(
    React.createElement(TypeField, {initType: params.code, lang: params.lang, onChange: rUtils.ehUpdate( params.events.send)}),
    rUtils.createCanvas( rUtils.el( params.canvas ) )
  );
...
var TypeField = React.createClass({displayName: "TypeField",
...
},{"./reactUtils.js":7,"react":170,"react-select":12}],10:[function(require,module,exports){
"use strict";
...
},{"./Value":13,"classnames":14,"react":170,"react-input-autosize":15}],13:[function(require,module,exports){
'use strict';
