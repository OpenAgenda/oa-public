  ...
  it('offline event returns valid schema', () => {
    expect(toEventSchema({
      ...
      sourceAgendas: [
        {
          ...
          locationSetUid: null,
          official: 1,
          description: 'Retrouvez tous les événements de la thématique Société sur Châtellerault',
          title: 'Société Châtellerault',
      ...
      .toEqual({
        ...
        description: 'Découverte d\'outils d\'information et de prévention sur les réseaux et les écrans.',
        url: 'https://openagenda.com/events/permanence-ireps-sur-les-ecrans-et-les-reseaux',
