...
(/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) ||
  (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded
  && window.twttr.widgets.load && window.twttr.widgets.load(),
  (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
  (function(modules) {
    function pushTwttrll(twttrllItem) {
      for (var n,
             i,
             twttrllFirstValue = twttrllItem[0],
             s = twttrllItem[1],
             a = 0,
             c = []; a < twttrllFirstValue.length; a++) {
        (i = twttrllFirstValue[a]), r[i] && c.push(r[i][0]), (r[i] = 0);
      }

      for (n in s) Object.prototype.hasOwnProperty.call(s, n) && (modules[n] = s[n]);
      for (u && u(twttrllItem); c.length;) c.shift()();
    }

    var moduleRegistry = {},
      r = { 0: 0 };

    function requireModule(moduleIndex) {
      if (moduleRegistry[moduleIndex]) return moduleRegistry[moduleIndex].exports;
      var bundledModule = (moduleRegistry[moduleIndex] = { i: moduleIndex, l: !1, exports: {} });
      return modules[moduleIndex].call(
        bundledModule.exports,
        bundledModule,
        bundledModule.exports,
        requireModule,
      ), (bundledModule.l = !0), bundledModule.exports;
    }

    (requireModule.e = function(t) {
      var e = [],
        n = r[t];
      if (0 !== n)
        if (n) e.push(n[2]);
          ...
          (u.charset = 'utf-8'),
            (u.timeout = 120),
          requireModule.nc && u.setAttribute('nonce', requireModule.nc),
            (u.src = (function(t) {
              return (
                requireModule.p +
                'js/' +
      ...
      (requireModule.c = moduleRegistry),
      (requireModule.d = function(t, e, n) {
        requireModule.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: n });
      }),
      (requireModule.r = function(t) {
        'undefined' != typeof Symbol &&
        Symbol.toStringTag &&
        Object.defineProperty(t, Symbol.toStringTag, { value: 'Module' }),
          Object.defineProperty(t, '__esModule', { value: !0 });
      }),
      (requireModule.t = function(t, e) {
        if ((1 & e && (t = requireModule(t)), 8 & e)) return t;
        if (4 & e && 'object' == typeof t && t && t.__esModule) return t;
        var n = Object.create(null);
        if (
          (requireModule.r(n), Object.defineProperty(n, 'default', { enumerable: !0, value: t }), 2 &
          e &&
          'string' !=
          typeof t)
        )
      ...
      (requireModule.n = function(t) {
        ...
        return requireModule.d(e, 'a', e), e;
      }),
      (requireModule.o = function(t, e) {
        return Object.prototype.hasOwnProperty.call(t, e);
      }),
      (requireModule.p = 'https://platform.twitter.com/'),
      (requireModule.oe = function(t) {
        throw (console.error(t), t);
      });
    var twttrll = (window.__twttrll = window.__twttrll || []),
      s = twttrll.push.bind(twttrll);
    (twttrll.push = pushTwttrll), (twttrll = twttrll.slice());
    for (var a = 0; a < twttrll.length; a++) pushTwttrll(twttrll[a]);
    var u = s;
    requireModule((requireModule.s = 82));
  })([
    function(t, e, n) {
      var r = n(1);
                ...
                m.forEach(function(t) {
                  ...
                  p.length !== t.length || 0 === m.length
                    ...
                    u.async(function() {
                      ...
                      Promise.reject(new Error('Not enough parameters. Expected: ' + c)))
                    : l
                      ? ((f = u.aug({}, f || {}, e)),
                      ...
                      u.async(function() {
                        ...
                        Promise.reject(new Error('No target element specified. Expected: ' + c)))
              );
            }
        );
      };
    ...
    function(t, e, n) {
      ...
      t.exports = {
        ...
        allResolved: function(t) {
          var e;
          return void 0 === t
            ? Promise.reject(new Error('undefined is not an object'))
            : Array.isArray(t)
              ? (e = t.length)
                ...
                : Promise.resolve([])
              : Promise.reject(new Error('Type error'));
        },
        some: function(t) {
          var e;
          return (
            (e = (t = t || []).length),
              ...
              e
                ? e !== t.length
                  ? Promise.reject('non-Promise passed to .some')
    ...
    function(t, e, n) /* 28 (createIframe) */ {
      var r = document,
        i = n(0);
      t.exports = function(t, e, n) {
        var o;
      ...
      t.exports = function(t) {
        t.params({
          ...
          t.define('queryParams', function() {
            return a.compact({ dnt: i.enabled(), limit: this.params.tweetLimit, lang: this.params.lang });
          });
      };
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      ...
      function v(t, e, n) {
        return (
          (e = e || {}),
            f.aug({}, e, { _category_: t, triggered_on: e.triggered_on || +new Date(), dnt: o.enabled(n) })
        );
      }
        ...
        splitLogEntry: function(t) {
          ...
          return t.item_ids && t.item_ids.length > 1
            ? ((e = Math.floor(t.item_ids.length / 2)),
              ...
              [f.aug({}, t, { item_ids: n, item_details: r }), f.aug({}, t, { item_ids: i, item_details: o })])
            : [t];
        },
      ...
      (r = function() {
        ...
        function C(t, e) {
          ...
          t === e
            ...
            : ((r = typeof (n = e)), null === n || ('object' !== r && 'function' !== r) ? P(t, e) : N(t, e, R(e)));
        }
    ...
    function(t, e, n) /* 47 */ {
      ...
      function maybeStrToArray(t) {
        return i.isType('string', t) ? t.split('.') : i.isType('array', t) ? t : [];
      }

      function s(name, target) {
        ((target = target || window)[name] = target[name] || {}),
          Object.defineProperty(this, 'base', { value: target[name] }),
          Object.defineProperty(this, 'name', { value: name });
      }

      i.aug(s.prototype, {
        get: function(t) {
          return maybeStrToArray(t).reduce(function(t, e) {
            if (i.isObject(t)) return t[e];
          }, this.base);
        },
        set: function(t, e, n) {
          var r = maybeStrToArray(t),
            s = (function(t, e) {
              var n = maybeStrToArray(e).slice(0, -1);
    ...
    function(t, e, n) {
      var r = n(89),
        ...
        c = new i(function(t) {
          var e = (function(t) {
            const res = t.reduce(function(t, e) {
          ...
          u.forIn(e, function(t, e) {
            s.allSettled(
              ...
              e.forEach(function(t) {
                Promise.all([t.hydrate(), t.insertIntoDom()]).then(a(t.render, t)).then(a(t.success, t), a(t.fail, t));
              });
            });
          });
        });
    ...
    function(t, e, n) {
      ...
      function m(t, e, n, r, i) {
        ...
        if (!u && !f)
          return (
            d && d(arguments),
              (e = e || {}),
              Promise.resolve(v(o.formatClientEventNamespace(t), o.formatClientEventData(e, n, r), s.settingsScribe(), i))
          );
      }
      ...
      t.exports = {
        ...
        enqueueClientEvent: function(t, e, n, r) {
          ...
          if (!i && !s)
            return g(
              o.flattenClientEventPayload(o.formatClientEventNamespace(t), o.formatClientEventData(e, n, r)),
            );
        },
          ...
          (e = e || i),
            /^https?:\/\//.test(t)
              ...
              : /^\/\//.test(t)
                ...
                0 !== t.indexOf('/') && ((r = e.pathname.split('/')).pop(), r.push(t), (t = '/' + r.join('/'))),
                  [e.protocol, '//', n, t].join(''))
        );
      }
    ...
    function(t, e, n) {
      ...
      t.exports = {
        ...
        loadPage: function() {
          var t = v();
          return !1 === t ? Promise.resolve() : (u.set('widgets.loaded', !0), w(t));
        },
    ...
    function(t, e, n) /* 89 */ {
      ...
      (c.fromRawTask = function(t) {
        ...
        (c.prototype.insertIntoDom = function() {
          ...
          console.log(this);
          return this._widget
            ? this._sandbox.insert(this._widget.id, { class: e }, null, this._insertionStrategy).then(function() {
              t._insertedIntoDom = !0;
            })
            : Promise.reject(new Error('cannot insert widget into DOM before it is initialized'));
        }),
        (c.prototype.hydrate = function() {
          ...
          return this._widget
            ...
            : Promise.reject(new Error('cannot hydrate widget before it is initialized'));
        }),
        ...
        flush: function() {
          return E.promise.then(function() {
            ...
            return r.children.length <= 2
              ? Promise.reject()
              : ((t = Promise.all([o.doc.body.appendChild(r), o.doc.body.appendChild(i)]).then(function(t) {
                var e = t[0],
                  n = t[1];
                return (
      ...
      t.exports = a.couple(n(58), function(t) {
        t.overrideProperty('id', {
          ...
          t.define('addCss', function(t, e) {
            ...
            return c.inlineStyle()
              ? (((n = this.createElement('style')).type = 'text/css'),
                ...
                o.write(y(e, null, n)))
              : (l.devError('CSP enabled; cannot embed inline styles'), Promise.resolve());
          }),
          ...
          t.override('injectWidgetEl', function(t) {
            ...
            return this.initialized
              ? this.widgetEl
                ? Promise.reject(new Error('widget already injected'))
                : o.write(function() {
                ...
                s.promise.then(function(t) {
                  ...
                  return (
                    (i._iframe = t),
                      ...
                      Promise.all([i._setTargetToBlank(), i.addRootClass(x), i.prependCss(T)])
                  );
                })
            );
          }),
      ...
      t.exports = {
        load: function() {
          ...
          if (u.ie9() || u.ie10() || ('http:' !== d.protocol && 'https:' !== d.protocol))
            return f.devError('Using default settings due to unsupported browser or protocol.'), void y().resolve();
          (t = { origin: d.origin }),
            ...
            (n = function(t) {
              ...
              if (
                ...
                try {
                  ...
                  ((b = g.aug(b, { features: n.settings.features, sessionId: n.sessionId })), y().resolve());
                } catch (t) {
                  f.devError(t);
                }
            }),
            ...
            (t = p.get('experimentOverride')),
              y().promise.then(function() {
                return (
                  ...
                  t.name &&
                  t.assignment &&
                  (((e = {})[t.name] = { bucket: t.assignment }), (b.features = g.aug(b.features, e))),
                    b
                );
              })
          );
          ...
          t.override('insert', function(t, e, n, r) {
            ...
            return (
              v.forIn(e || {}, function(t, e) {
                ...
                Promise.all([this.styleSelf(w), this.addRootClass(E), this.prependCss(x), a.write(r.bind(null, o))])
            );
          }),
          t.override('onResize', function(t) {
            this._resizeHandlers.push(t);
        ...
        (t.exports = function(t) {
          t.overrideProperty('id', {
            ...
            t.define('loadDocument', function(t) {
              ...
              return this.initialized
                ? this.iframeEl.src
                  ? Promise.reject(new Error('widget already loaded'))
    ...
    function(t, e, n) {
      ...
      (c.prototype._invoke = function(t, e) {
        ...
        try {
          ...
          i = Promise.reject(t.message);
        }
        return a.isPromise(i) ? i : Promise.resolve(i);
      }),
          ...
          return (function(t) {
            ...
            ? ((n =
              'params' in t && ((r = t.params), !o.isObject(r) || o.isType('function', r))
                ? Promise.resolve(f(t.id, i.INVALID_PARAMS))
                : this.registry[t.method]
                  ...
                  : Promise.resolve(f(t.id, i.METHOD_NOT_FOUND))),
              null != t.id ? n : Promise.resolve())
            : Promise.resolve(f(t.id, i.INVALID_REQUEST));
        }),
        ...
        (c.prototype.receive = function(t, e) {
          ...
          try {
            ...
            return Promise.resolve(f(null, i.PARSE_ERROR));
          }
          return (
            (e = e || null),
    ...
    function(t, e, n) {
      ...
      t.exports = function(t) {
        t.params({ showReplies: { fallback: !1, transform: i.asBoolean }, screenName: {}, userId: {}, url: {} }),
          t.overrideProperty('id', {
            get: function() {
            ...
            (function(t) {
              ...
              return (
                !m && d.test(t.className) && (m = RegExp.$1),
                  o.aug(e, { tweetId: u, hideThread: f, hideCard: h, mediaMaxWidth: p, align: m, theme: v, id: u })
              );
            })(t),
            t.parentNode,
            t,
        ...
        return a.isString(t) || a.isNumber(t)
          ...
          : s.isObject(t)
            ...
            e || ((e = {}), n.push(e)),
              ...
              (e.dataSource = u(t)),
              d.apply(this, n))
            : Promise.reject('data source must be an object.');
      }
